...
#ifndef OAIV0_0_39_job_desc_msg_H
#define OAIV0_0_39_job_desc_msg_H
...
namespace OpenAPI {
class OAIV0_0_39_cron_entry;
class OAIV0_0_39_uint32_no_val;
class OAIV0_0_39_uint16_no_val;
class OAIV0_0_39_uint64_no_val;

class OAIV0_0_39_job_desc_msg : public OAIObject {
public:
    OAIV0_0_39_job_desc_msg();
    OAIV0_0_39_job_desc_msg(QString json);
    ~OAIV0_0_39_job_desc_msg() override;
    ...
    qint64 getBeginTime() const;
    void setBeginTime(const qint64 &begin_time);
    ...
    OAIV0_0_39_cron_entry getCrontab() const;
    void setCrontab(const OAIV0_0_39_cron_entry &crontab);
    ...
    QList<QString> getPowerFlags() const;
    void setPowerFlags(const QList<QString> &power_flags);
    bool is_power_flags_Set() const;
    bool is_power_flags_Valid() const;
    ...
    OAIV0_0_39_uint16_no_val getKillWarningDelay() const;
    void setKillWarningDelay(const OAIV0_0_39_uint16_no_val &kill_warning_delay);
    ...
    OAIV0_0_39_uint32_no_val getRequiredSwitches() const;
    void setRequiredSwitches(const OAIV0_0_39_uint32_no_val &required_switches);
...
private:
    ...
    OAIV0_0_39_cron_entry m_crontab;
    ...
    OAIV0_0_39_uint16_no_val m_kill_warning_delay;
    ...
    OAIV0_0_39_uint32_no_val m_required_switches;
...
Q_DECLARE_METATYPE(OpenAPI::OAIV0_0_39_job_desc_msg)

#endif // OAIV0_0_39_job_desc_msg_H
