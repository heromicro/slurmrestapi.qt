...
/*
 * OAIV0_0_40_openapi_nodes_resp.h
 *
 * 
 */

#ifndef OAIV0_0_40_openapi_nodes_resp_H
#define OAIV0_0_40_openapi_nodes_resp_H
...
class OAIV0_0_40_openapi_nodes_resp : public OAIObject {
public:
    OAIV0_0_40_openapi_nodes_resp();
    OAIV0_0_40_openapi_nodes_resp(QString json);
    ~OAIV0_0_40_openapi_nodes_resp() override;
    ...
    QList<OAIV0_0_40_node> getNodes() const;
    void setNodes(const QList<OAIV0_0_40_node> &nodes);
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_40_openapi_nodes_resp)

#endif // OAIV0_0_40_openapi_nodes_resp_H
