...
OAIV0_0_39_uint32_no_val OAIV0_0_39_partition_info_maximums::getCpusPerNode() const {
    return m_cpus_per_node;
}
void OAIV0_0_39_partition_info_maximums::setCpusPerNode(const OAIV0_0_39_uint32_no_val &cpus_per_node) {
    m_cpus_per_node = cpus_per_node;
    m_cpus_per_node_isSet = true;
}

bool OAIV0_0_39_partition_info_maximums::is_cpus_per_node_Set() const{
    return m_cpus_per_node_isSet;
}

bool OAIV0_0_39_partition_info_maximums::is_cpus_per_node_Valid() const{
    return m_cpus_per_node_isValid;
}

OAIV0_0_39_uint32_no_val OAIV0_0_39_partition_info_maximums::getCpusPerSocket() const {
    return m_cpus_per_socket;
}
void OAIV0_0_39_partition_info_maximums::setCpusPerSocket(const OAIV0_0_39_uint32_no_val &cpus_per_socket) {
    m_cpus_per_socket = cpus_per_socket;
    m_cpus_per_socket_isSet = true;
}

bool OAIV0_0_39_partition_info_maximums::is_cpus_per_socket_Set() const{
    return m_cpus_per_socket_isSet;
}

bool OAIV0_0_39_partition_info_maximums::is_cpus_per_socket_Valid() const{
    return m_cpus_per_socket_isValid;
}

qint64 OAIV0_0_39_partition_info_maximums::getMemoryPerCpu() const {
    return m_memory_per_cpu;
}
void OAIV0_0_39_partition_info_maximums::setMemoryPerCpu(const qint64 &memory_per_cpu) {
    m_memory_per_cpu = memory_per_cpu;
    m_memory_per_cpu_isSet = true;
}

bool OAIV0_0_39_partition_info_maximums::is_memory_per_cpu_Set() const{
    return m_memory_per_cpu_isSet;
}

bool OAIV0_0_39_partition_info_maximums::is_memory_per_cpu_Valid() const{
    return m_memory_per_cpu_isValid;
}

OAIV0_0_39_uint32_no_val OAIV0_0_39_partition_info_maximums::getNodes() const {
    return m_nodes;
}
void OAIV0_0_39_partition_info_maximums::setNodes(const OAIV0_0_39_uint32_no_val &nodes) {
    m_nodes = nodes;
    m_nodes_isSet = true;
}

bool OAIV0_0_39_partition_info_maximums::is_nodes_Set() const{
    return m_nodes_isSet;
}

bool OAIV0_0_39_partition_info_maximums::is_nodes_Valid() const{
    return m_nodes_isValid;
}

qint32 OAIV0_0_39_partition_info_maximums::getShares() const {
    return m_shares;
}
void OAIV0_0_39_partition_info_maximums::setShares(const qint32 &shares) {
    m_shares = shares;
    m_shares_isSet = true;
}

bool OAIV0_0_39_partition_info_maximums::is_shares_Set() const{
    return m_shares_isSet;
}

bool OAIV0_0_39_partition_info_maximums::is_shares_Valid() const{
    return m_shares_isValid;
}

OAIV0_0_39_uint32_no_val OAIV0_0_39_partition_info_maximums::getTime() const {
    return m_time;
}
void OAIV0_0_39_partition_info_maximums::setTime(const OAIV0_0_39_uint32_no_val &time) {
    m_time = time;
    m_time_isSet = true;
}

bool OAIV0_0_39_partition_info_maximums::is_time_Set() const{
    return m_time_isSet;
}

bool OAIV0_0_39_partition_info_maximums::is_time_Valid() const{
