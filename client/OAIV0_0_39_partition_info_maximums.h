...
#ifndef OAIV0_0_39_partition_info_maximums_H
#define OAIV0_0_39_partition_info_maximums_H
...
class OAIV0_0_39_partition_info_maximums : public OAIObject {
public:
    OAIV0_0_39_partition_info_maximums();
    OAIV0_0_39_partition_info_maximums(QString json);
    ~OAIV0_0_39_partition_info_maximums() override;
    ...
    OAIV0_0_39_uint32_no_val getCpusPerNode() const;
    void setCpusPerNode(const OAIV0_0_39_uint32_no_val &cpus_per_node);
    bool is_cpus_per_node_Set() const;
    bool is_cpus_per_node_Valid() const;

    OAIV0_0_39_uint32_no_val getCpusPerSocket() const;
    void setCpusPerSocket(const OAIV0_0_39_uint32_no_val &cpus_per_socket);
    ...
    OAIV0_0_39_uint32_no_val getNodes() const;
    void setNodes(const OAIV0_0_39_uint32_no_val &nodes);
    ...
    OAIV0_0_39_uint16_no_val getOverTimeLimit() const;
    void setOverTimeLimit(const OAIV0_0_39_uint16_no_val &over_time_limit);
...
private:
    ...
    OAIV0_0_39_uint32_no_val m_cpus_per_node;
    bool m_cpus_per_node_isSet;
    bool m_cpus_per_node_isValid;

    OAIV0_0_39_uint32_no_val m_cpus_per_socket;
    ...
    OAIV0_0_39_uint32_no_val m_nodes;
    bool m_nodes_isSet;
    ...
    OAIV0_0_39_uint16_no_val m_over_time_limit;
