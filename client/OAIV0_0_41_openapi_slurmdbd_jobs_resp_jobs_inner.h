...
/*
 * OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner.h
 *
 * 
 */

#ifndef OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_H
#define OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_H
...
#include "OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_het.h"
...
#include "OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time.h"
#include "OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_tres.h"
#include "OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_wckey.h"
#include <QList>
#include <QString>
...
class OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_array;
class OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association;
class OAIV0_0_41_openapi_job_info_resp_jobs_inner_derived_exit_code;
class OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time;
class OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_exit_code;
class OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_het;
class OAIV0_0_40_job_mcs;
class OAIV0_0_41_job_desc_msg_priority;
class OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required;
class OAIV0_0_40_job_reservation;
class OAIV0_0_40_job_state;
class OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_steps_inner;
class OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_tres;
class OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_wckey;

class OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner : public OAIObject {
public:
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner();
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner(QString json);
    ~OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner() override;
    ...
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_array getArray() const;
    void setArray(const OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_array &array);
    bool is_array_Set() const;
    bool is_array_Valid() const;

    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association getAssociation() const;
    void setAssociation(const OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association &association);
    ...
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time getTime() const;
    void setTime(const OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time &time);
    ...
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_het getHet() const;
    void setHet(const OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_het &het);
    ...
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required getRequired() const;
    void setRequired(const OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required &required);
    ...
    QString getStdinExpanded() const;
    void setStdinExpanded(const QString &stdin_expanded);
    bool is_stdin_expanded_Set() const;
    bool is_stdin_expanded_Valid() const;

    QString getStdoutExpanded() const;
    void setStdoutExpanded(const QString &stdout_expanded);
    bool is_stdout_expanded_Set() const;
    bool is_stdout_expanded_Valid() const;

    QString getStderrExpanded() const;
    void setStderrExpanded(const QString &stderr_expanded);
    bool is_stderr_expanded_Set() const;
    bool is_stderr_expanded_Valid() const;
    ...
    QString getStdin() const;
    void setStdin(const QString &stdin);
    bool is_stdin_Set() const;
    bool is_stdin_Valid() const;
    ...
    QList<OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_steps_inner> getSteps() const;
    void setSteps(const QList<OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_steps_inner> &steps);
    ...
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_tres getTres() const;
    void setTres(const OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_tres &tres);
    ...
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_wckey getWckey() const;
    void setWckey(const OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_wckey &wckey);
...
private:
    ...
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_array m_array;
    bool m_array_isSet;
    bool m_array_isValid;

    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association m_association;
    ...
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time m_time;
    bool m_time_isSet;
    bool m_time_isValid;
    ...
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_het m_het;
    bool m_het_isSet;
    bool m_het_isValid;
    ...
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required m_required;
    ...
    QString m_stdin_expanded;
    bool m_stdin_expanded_isSet;
    bool m_stdin_expanded_isValid;

    QString m_stdout_expanded;
    bool m_stdout_expanded_isSet;
    bool m_stdout_expanded_isValid;

    QString m_stderr_expanded;
    bool m_stderr_expanded_isSet;
    bool m_stderr_expanded_isValid;
    ...
    QString m_stdin;
    bool m_stdin_isSet;
    bool m_stdin_isValid;

    OAIV0_0_40_job_state m_state;
    bool m_state_isSet;
    bool m_state_isValid;

    QList<OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_steps_inner> m_steps;
    bool m_steps_isSet;
    ...
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_tres m_tres;
    bool m_tres_isSet;
    bool m_tres_isValid;
    ...
    OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_wckey m_wckey;
    bool m_wckey_isSet;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner)

#endif // OAIV0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_H
