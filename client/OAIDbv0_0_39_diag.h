...
#ifndef OAIDbv0_0_39_diag_H
#define OAIDbv0_0_39_diag_H
...
class OAIV0_0_39_stats_rec;

class OAIDbv0_0_39_diag : public OAIObject {
public:
    OAIDbv0_0_39_diag();
    OAIDbv0_0_39_diag(QString json);
    ~OAIDbv0_0_39_diag() override;
    ...
    OAIV0_0_39_stats_rec getStatistics() const;
    void setStatistics(const OAIV0_0_39_stats_rec &statistics);
...
private:
    ...
    OAIV0_0_39_stats_rec m_statistics;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIDbv0_0_39_diag)

#endif // OAIDbv0_0_39_diag_H
