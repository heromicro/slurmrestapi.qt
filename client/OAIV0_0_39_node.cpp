...
OAIV0_0_39_ext_sensors_data OAIV0_0_39_node::getExternalSensors() const {
    return m_external_sensors;
}
void OAIV0_0_39_node::setExternalSensors(const OAIV0_0_39_ext_sensors_data &external_sensors) {
...
OAIV0_0_39_power_mgmt_data OAIV0_0_39_node::getPower() const {
    return m_power;
}
void OAIV0_0_39_node::setPower(const OAIV0_0_39_power_mgmt_data &power) {
    m_power = power;
    m_power_isSet = true;
}
