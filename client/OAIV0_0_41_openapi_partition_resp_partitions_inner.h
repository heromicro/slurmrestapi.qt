...
/*
 * OAIV0_0_41_openapi_partition_resp_partitions_inner.h
 *
 * 
 */

#ifndef OAIV0_0_41_openapi_partition_resp_partitions_inner_H
#define OAIV0_0_41_openapi_partition_resp_partitions_inner_H
...
#include "OAIV0_0_41_openapi_partition_resp_partitions_inner_timeouts.h"
#include <QList>
#include <QString>
...
class OAIV0_0_41_openapi_partition_resp_partitions_inner_defaults;
class OAIV0_0_41_openapi_partition_resp_partitions_inner_maximums;
class OAIV0_0_40_partition_info_minimums;
class OAIV0_0_40_partition_info_priority;
class OAIV0_0_41_openapi_partition_resp_partitions_inner_timeouts;
class OAIV0_0_40_partition_info_partition;
class OAIV0_0_41_openapi_partition_resp_partitions_inner_suspend_time;

class OAIV0_0_41_openapi_partition_resp_partitions_inner : public OAIObject {
public:
    OAIV0_0_41_openapi_partition_resp_partitions_inner();
    OAIV0_0_41_openapi_partition_resp_partitions_inner(QString json);
    ~OAIV0_0_41_openapi_partition_resp_partitions_inner() override;
    ...
    OAIV0_0_41_openapi_partition_resp_partitions_inner_defaults getDefaults() const;
    void setDefaults(const OAIV0_0_41_openapi_partition_resp_partitions_inner_defaults &defaults);
    ...
    OAIV0_0_41_openapi_partition_resp_partitions_inner_maximums getMaximums() const;
    void setMaximums(const OAIV0_0_41_openapi_partition_resp_partitions_inner_maximums &maximums);
    ...
    OAIV0_0_41_openapi_partition_resp_partitions_inner_timeouts getTimeouts() const;
    void setTimeouts(const OAIV0_0_41_openapi_partition_resp_partitions_inner_timeouts &timeouts);
    ...
    OAIV0_0_41_openapi_partition_resp_partitions_inner_suspend_time getSuspendTime() const;
    void setSuspendTime(const OAIV0_0_41_openapi_partition_resp_partitions_inner_suspend_time &suspend_time);
...
private:
    ...
    OAIV0_0_41_openapi_partition_resp_partitions_inner_defaults m_defaults;
    ...
    OAIV0_0_41_openapi_partition_resp_partitions_inner_maximums m_maximums;
    ...
    OAIV0_0_41_openapi_partition_resp_partitions_inner_timeouts m_timeouts;
    ...
    OAIV0_0_41_openapi_partition_resp_partitions_inner_suspend_time m_suspend_time;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_41_openapi_partition_resp_partitions_inner)

#endif // OAIV0_0_41_openapi_partition_resp_partitions_inner_H
