...
/*
 * OAIV0_0_40_openapi_wckey_removed_resp.h
 *
 * 
 */

#ifndef OAIV0_0_40_openapi_wckey_removed_resp_H
#define OAIV0_0_40_openapi_wckey_removed_resp_H
...
class OAIV0_0_40_openapi_wckey_removed_resp : public OAIObject {
public:
    OAIV0_0_40_openapi_wckey_removed_resp();
    OAIV0_0_40_openapi_wckey_removed_resp(QString json);
    ~OAIV0_0_40_openapi_wckey_removed_resp() override;
    ...
    QList<QString> getDeletedWckeys() const;
    void setDeletedWckeys(const QList<QString> &deleted_wckeys);
    bool is_deleted_wckeys_Set() const;
    bool is_deleted_wckeys_Valid() const;
...
private:
    ...
    QList<QString> m_deleted_wckeys;
    bool m_deleted_wckeys_isSet;
    bool m_deleted_wckeys_isValid;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_40_openapi_wckey_removed_resp)

#endif // OAIV0_0_40_openapi_wckey_removed_resp_H
