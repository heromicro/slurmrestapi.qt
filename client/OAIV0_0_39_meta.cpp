...
OAIV0_0_39_meta_plugin OAIV0_0_39_meta::getPlugin() const {
    return m_plugin;
}
void OAIV0_0_39_meta::setPlugin(const OAIV0_0_39_meta_plugin &plugin) {
    m_plugin = plugin;
    m_plugin_isSet = true;
}
...
OAIV0_0_39_meta_Slurm OAIV0_0_39_meta::getSlurm() const {
    return m_slurm;
}
void OAIV0_0_39_meta::setSlurm(const OAIV0_0_39_meta_Slurm &slurm) {
    m_slurm = slurm;
    m_slurm_isSet = true;
}
