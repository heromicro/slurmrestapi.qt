...
/*
 * OAIV0_0_41_openapi_users_add_cond_resp.h
 *
 * 
 */

#ifndef OAIV0_0_41_openapi_users_add_cond_resp_H
#define OAIV0_0_41_openapi_users_add_cond_resp_H
...
class OAIV0_0_41_openapi_users_add_cond_resp_association_condition;
class OAIV0_0_41_openapi_users_add_cond_resp_user;
...
class OAIV0_0_41_openapi_users_add_cond_resp : public OAIObject {
public:
    OAIV0_0_41_openapi_users_add_cond_resp();
    OAIV0_0_41_openapi_users_add_cond_resp(QString json);
    ~OAIV0_0_41_openapi_users_add_cond_resp() override;
    ...
    OAIV0_0_41_openapi_users_add_cond_resp_association_condition getAssociationCondition() const;
    void setAssociationCondition(const OAIV0_0_41_openapi_users_add_cond_resp_association_condition &association_condition);
    bool is_association_condition_Set() const;
    bool is_association_condition_Valid() const;

    OAIV0_0_41_openapi_users_add_cond_resp_user getUser() const;
    void setUser(const OAIV0_0_41_openapi_users_add_cond_resp_user &user);
...
private:
    ...
    OAIV0_0_41_openapi_users_add_cond_resp_association_condition m_association_condition;
    bool m_association_condition_isSet;
    bool m_association_condition_isValid;

    OAIV0_0_41_openapi_users_add_cond_resp_user m_user;
    bool m_user_isSet;
    bool m_user_isValid;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_41_openapi_users_add_cond_resp)

#endif // OAIV0_0_41_openapi_users_add_cond_resp_H
