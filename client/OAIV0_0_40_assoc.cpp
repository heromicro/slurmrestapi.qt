...
OAIV0_0_40_assoc::OAIV0_0_40_assoc() {
    this->initializeModel();
}

OAIV0_0_40_assoc::~OAIV0_0_40_assoc() {}

void OAIV0_0_40_assoc::initializeModel() {
...
void OAIV0_0_40_assoc::fromJson(QString jsonString) {
...
QString OAIV0_0_40_assoc::asJson() const {
...
QList<OAIV0_0_40_accounting> OAIV0_0_40_assoc::getAccounting() const {
    return m_accounting;
}
void OAIV0_0_40_assoc::setAccounting(const QList<OAIV0_0_40_accounting> &accounting) {
    m_accounting = accounting;
    m_accounting_isSet = true;
}

bool OAIV0_0_40_assoc::is_accounting_Set() const{
    return m_accounting_isSet;
}

bool OAIV0_0_40_assoc::is_accounting_Valid() const{
    return m_accounting_isValid;
}

QString OAIV0_0_40_assoc::getAccount() const {
    return m_account;
}
void OAIV0_0_40_assoc::setAccount(const QString &account) {
    m_account = account;
    m_account_isSet = true;
}

bool OAIV0_0_40_assoc::is_account_Set() const{
    return m_account_isSet;
}

bool OAIV0_0_40_assoc::is_account_Valid() const{
    return m_account_isValid;
}

QString OAIV0_0_40_assoc::getCluster() const {
    return m_cluster;
}
void OAIV0_0_40_assoc::setCluster(const QString &cluster) {
    m_cluster = cluster;
    m_cluster_isSet = true;
}

bool OAIV0_0_40_assoc::is_cluster_Set() const{
    return m_cluster_isSet;
}

bool OAIV0_0_40_assoc::is_cluster_Valid() const{
    return m_cluster_isValid;
}

QString OAIV0_0_40_assoc::getComment() const {
    return m_comment;
}
void OAIV0_0_40_assoc::setComment(const QString &comment) {
    m_comment = comment;
    m_comment_isSet = true;
}

bool OAIV0_0_40_assoc::is_comment_Set() const{
    return m_comment_isSet;
}

bool OAIV0_0_40_assoc::is_comment_Valid() const{
    return m_comment_isValid;
}

OAIV0_0_40_assoc_default OAIV0_0_40_assoc::getRDefault() const {
    return m_r_default;
}
void OAIV0_0_40_assoc::setRDefault(const OAIV0_0_40_assoc_default &r_default) {
    m_r_default = r_default;
    m_r_default_isSet = true;
}

bool OAIV0_0_40_assoc::is_r_default_Set() const{
    return m_r_default_isSet;
}

bool OAIV0_0_40_assoc::is_r_default_Valid() const{
    return m_r_default_isValid;
}

QList<QString> OAIV0_0_40_assoc::getFlags() const {
    return m_flags;
}
void OAIV0_0_40_assoc::setFlags(const QList<QString> &flags) {
    m_flags = flags;
    m_flags_isSet = true;
}

bool OAIV0_0_40_assoc::is_flags_Set() const{
    return m_flags_isSet;
}

bool OAIV0_0_40_assoc::is_flags_Valid() const{
    return m_flags_isValid;
}

OAIV0_0_40_assoc_max OAIV0_0_40_assoc::getMax() const {
    return m_max;
}
void OAIV0_0_40_assoc::setMax(const OAIV0_0_40_assoc_max &max) {
    m_max = max;
    m_max_isSet = true;
}

bool OAIV0_0_40_assoc::is_max_Set() const{
    return m_max_isSet;
}

bool OAIV0_0_40_assoc::is_max_Valid() const{
    return m_max_isValid;
}

OAIV0_0_40_assoc_short OAIV0_0_40_assoc::getId() const {
    return m_id;
}
void OAIV0_0_40_assoc::setId(const OAIV0_0_40_assoc_short &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIV0_0_40_assoc::is_id_Set() const{
    return m_id_isSet;
}

bool OAIV0_0_40_assoc::is_id_Valid() const{
    return m_id_isValid;
}

bool OAIV0_0_40_assoc::isIsDefault() const {
    return m_is_default;
}
void OAIV0_0_40_assoc::setIsDefault(const bool &is_default) {
    m_is_default = is_default;
    m_is_default_isSet = true;
}

bool OAIV0_0_40_assoc::is_is_default_Set() const{
    return m_is_default_isSet;
}

bool OAIV0_0_40_assoc::is_is_default_Valid() const{
    return m_is_default_isValid;
}

QString OAIV0_0_40_assoc::getLineage() const {
    return m_lineage;
}
void OAIV0_0_40_assoc::setLineage(const QString &lineage) {
    m_lineage = lineage;
    m_lineage_isSet = true;
}

bool OAIV0_0_40_assoc::is_lineage_Set() const{
    return m_lineage_isSet;
}

bool OAIV0_0_40_assoc::is_lineage_Valid() const{
    return m_lineage_isValid;
}

OAIV0_0_40_assoc_min OAIV0_0_40_assoc::getMin() const {
    return m_min;
}
void OAIV0_0_40_assoc::setMin(const OAIV0_0_40_assoc_min &min) {
    m_min = min;
    m_min_isSet = true;
}

bool OAIV0_0_40_assoc::is_min_Set() const{
    return m_min_isSet;
}

bool OAIV0_0_40_assoc::is_min_Valid() const{
    return m_min_isValid;
}

QString OAIV0_0_40_assoc::getParentAccount() const {
    return m_parent_account;
}
void OAIV0_0_40_assoc::setParentAccount(const QString &parent_account) {
    m_parent_account = parent_account;
    m_parent_account_isSet = true;
}

bool OAIV0_0_40_assoc::is_parent_account_Set() const{
    return m_parent_account_isSet;
}

bool OAIV0_0_40_assoc::is_parent_account_Valid() const{
    return m_parent_account_isValid;
}

QString OAIV0_0_40_assoc::getPartition() const {
    return m_partition;
}
void OAIV0_0_40_assoc::setPartition(const QString &partition) {
    m_partition = partition;
    m_partition_isSet = true;
}

bool OAIV0_0_40_assoc::is_partition_Set() const{
    return m_partition_isSet;
}

bool OAIV0_0_40_assoc::is_partition_Valid() const{
    return m_partition_isValid;
}

OAIV0_0_40_uint32_no_val OAIV0_0_40_assoc::getPriority() const {
    return m_priority;
}
void OAIV0_0_40_assoc::setPriority(const OAIV0_0_40_uint32_no_val &priority) {
    m_priority = priority;
    m_priority_isSet = true;
}

bool OAIV0_0_40_assoc::is_priority_Set() const{
    return m_priority_isSet;
}

bool OAIV0_0_40_assoc::is_priority_Valid() const{
    return m_priority_isValid;
}

QList<QString> OAIV0_0_40_assoc::getQos() const {
    return m_qos;
}
void OAIV0_0_40_assoc::setQos(const QList<QString> &qos) {
    m_qos = qos;
    m_qos_isSet = true;
}

bool OAIV0_0_40_assoc::is_qos_Set() const{
    return m_qos_isSet;
}

bool OAIV0_0_40_assoc::is_qos_Valid() const{
    return m_qos_isValid;
}

qint32 OAIV0_0_40_assoc::getSharesRaw() const {
    return m_shares_raw;
}
void OAIV0_0_40_assoc::setSharesRaw(const qint32 &shares_raw) {
    m_shares_raw = shares_raw;
    m_shares_raw_isSet = true;
}

bool OAIV0_0_40_assoc::is_shares_raw_Set() const{
    return m_shares_raw_isSet;
}

bool OAIV0_0_40_assoc::is_shares_raw_Valid() const{
    return m_shares_raw_isValid;
}

QString OAIV0_0_40_assoc::getUser() const {
    return m_user;
}
void OAIV0_0_40_assoc::setUser(const QString &user) {
    m_user = user;
    m_user_isSet = true;
}

bool OAIV0_0_40_assoc::is_user_Set() const{
    return m_user_isSet;
}

bool OAIV0_0_40_assoc::is_user_Valid() const{
    return m_user_isValid;
}

bool OAIV0_0_40_assoc::isSet() const {
...
bool OAIV0_0_40_assoc::isValid() const {
