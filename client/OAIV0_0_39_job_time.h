...
#ifndef OAIV0_0_39_job_time_H
#define OAIV0_0_39_job_time_H
...
class OAIV0_0_39_job_time_system;
class OAIV0_0_39_uint32_no_val;

class OAIV0_0_39_job_time : public OAIObject {
public:
    OAIV0_0_39_job_time();
    OAIV0_0_39_job_time(QString json);
    ~OAIV0_0_39_job_time() override;
    ...
    OAIV0_0_39_job_time_system getSystem() const;
    void setSystem(const OAIV0_0_39_job_time_system &system);
    bool is_system_Set() const;
    bool is_system_Valid() const;

    OAIV0_0_39_uint32_no_val getLimit() const;
    void setLimit(const OAIV0_0_39_uint32_no_val &limit);
    bool is_limit_Set() const;
    bool is_limit_Valid() const;

    OAIV0_0_39_job_time_system getTotal() const;
    void setTotal(const OAIV0_0_39_job_time_system &total);
    bool is_total_Set() const;
    bool is_total_Valid() const;

    OAIV0_0_39_job_time_system getUser() const;
    void setUser(const OAIV0_0_39_job_time_system &user);
...
private:
    ...
    OAIV0_0_39_job_time_system m_system;
    bool m_system_isSet;
    bool m_system_isValid;

    OAIV0_0_39_uint32_no_val m_limit;
    bool m_limit_isSet;
    bool m_limit_isValid;

    OAIV0_0_39_job_time_system m_total;
    bool m_total_isSet;
    bool m_total_isValid;

    OAIV0_0_39_job_time_system m_user;
    bool m_user_isSet;
    bool m_user_isValid;
};
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_39_job_time)

#endif // OAIV0_0_39_job_time_H
