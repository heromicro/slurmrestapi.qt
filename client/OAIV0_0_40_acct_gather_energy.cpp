...
#include "OAIV0_0_40_acct_gather_energy.h"
...
OAIV0_0_40_acct_gather_energy::OAIV0_0_40_acct_gather_energy() {
    this->initializeModel();
}

OAIV0_0_40_acct_gather_energy::~OAIV0_0_40_acct_gather_energy() {}

void OAIV0_0_40_acct_gather_energy::initializeModel() {
...
void OAIV0_0_40_acct_gather_energy::fromJson(QString jsonString) {
...
QString OAIV0_0_40_acct_gather_energy::asJson() const {
...
qint32 OAIV0_0_40_acct_gather_energy::getAverageWatts() const {
    return m_average_watts;
}
void OAIV0_0_40_acct_gather_energy::setAverageWatts(const qint32 &average_watts) {
    m_average_watts = average_watts;
    m_average_watts_isSet = true;
}

bool OAIV0_0_40_acct_gather_energy::is_average_watts_Set() const{
    return m_average_watts_isSet;
}

bool OAIV0_0_40_acct_gather_energy::is_average_watts_Valid() const{
    return m_average_watts_isValid;
}

qint64 OAIV0_0_40_acct_gather_energy::getBaseConsumedEnergy() const {
    return m_base_consumed_energy;
}
void OAIV0_0_40_acct_gather_energy::setBaseConsumedEnergy(const qint64 &base_consumed_energy) {
    m_base_consumed_energy = base_consumed_energy;
    m_base_consumed_energy_isSet = true;
}

bool OAIV0_0_40_acct_gather_energy::is_base_consumed_energy_Set() const{
    return m_base_consumed_energy_isSet;
}

bool OAIV0_0_40_acct_gather_energy::is_base_consumed_energy_Valid() const{
    return m_base_consumed_energy_isValid;
}

qint64 OAIV0_0_40_acct_gather_energy::getConsumedEnergy() const {
    return m_consumed_energy;
}
void OAIV0_0_40_acct_gather_energy::setConsumedEnergy(const qint64 &consumed_energy) {
    m_consumed_energy = consumed_energy;
    m_consumed_energy_isSet = true;
}

bool OAIV0_0_40_acct_gather_energy::is_consumed_energy_Set() const{
    return m_consumed_energy_isSet;
}

bool OAIV0_0_40_acct_gather_energy::is_consumed_energy_Valid() const{
    return m_consumed_energy_isValid;
}

OAIV0_0_40_uint32_no_val OAIV0_0_40_acct_gather_energy::getCurrentWatts() const {
    return m_current_watts;
}
void OAIV0_0_40_acct_gather_energy::setCurrentWatts(const OAIV0_0_40_uint32_no_val &current_watts) {
    m_current_watts = current_watts;
    m_current_watts_isSet = true;
}

bool OAIV0_0_40_acct_gather_energy::is_current_watts_Set() const{
    return m_current_watts_isSet;
}

bool OAIV0_0_40_acct_gather_energy::is_current_watts_Valid() const{
    return m_current_watts_isValid;
}

qint64 OAIV0_0_40_acct_gather_energy::getPreviousConsumedEnergy() const {
    return m_previous_consumed_energy;
}
void OAIV0_0_40_acct_gather_energy::setPreviousConsumedEnergy(const qint64 &previous_consumed_energy) {
    m_previous_consumed_energy = previous_consumed_energy;
    m_previous_consumed_energy_isSet = true;
}

bool OAIV0_0_40_acct_gather_energy::is_previous_consumed_energy_Set() const{
    return m_previous_consumed_energy_isSet;
}

bool OAIV0_0_40_acct_gather_energy::is_previous_consumed_energy_Valid() const{
    return m_previous_consumed_energy_isValid;
}

qint64 OAIV0_0_40_acct_gather_energy::getLastCollected() const {
    return m_last_collected;
}
void OAIV0_0_40_acct_gather_energy::setLastCollected(const qint64 &last_collected) {
    m_last_collected = last_collected;
    m_last_collected_isSet = true;
}

bool OAIV0_0_40_acct_gather_energy::is_last_collected_Set() const{
    return m_last_collected_isSet;
}

bool OAIV0_0_40_acct_gather_energy::is_last_collected_Valid() const{
    return m_last_collected_isValid;
}

bool OAIV0_0_40_acct_gather_energy::isSet() const {
...
bool OAIV0_0_40_acct_gather_energy::isValid() const {
