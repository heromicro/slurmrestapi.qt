...
/*
 * OAIV0_0_41_openapi_nodes_resp_nodes_inner.h
 *
 * 
 */

#ifndef OAIV0_0_41_openapi_nodes_resp_nodes_inner_H
#define OAIV0_0_41_openapi_nodes_resp_nodes_inner_H

#include <QJsonObject>

#include "OAIObject.h"
#include "OAIV0_0_41_openapi_nodes_resp_nodes_inner_boot_time.h"
#include "OAIV0_0_41_openapi_nodes_resp_nodes_inner_energy.h"
#include "OAIV0_0_41_openapi_nodes_resp_nodes_inner_free_mem.h"
#include "OAIV0_0_41_openapi_nodes_resp_nodes_inner_last_busy.h"
#include "OAIV0_0_41_openapi_nodes_resp_nodes_inner_reason_changed_at.h"
#include "OAIV0_0_41_openapi_nodes_resp_nodes_inner_resume_after.h"
#include "OAIV0_0_41_openapi_nodes_resp_nodes_inner_slurmd_start_time.h"
#include <QList>
#include <QString>
...
class OAIV0_0_41_openapi_nodes_resp_nodes_inner_last_busy;
class OAIV0_0_41_openapi_nodes_resp_nodes_inner_reason_changed_at;
class OAIV0_0_41_openapi_nodes_resp_nodes_inner_resume_after;
class OAIV0_0_41_openapi_nodes_resp_nodes_inner_slurmd_start_time;

class OAIV0_0_41_openapi_nodes_resp_nodes_inner : public OAIObject {
public:
    OAIV0_0_41_openapi_nodes_resp_nodes_inner();
    OAIV0_0_41_openapi_nodes_resp_nodes_inner(QString json);
    ~OAIV0_0_41_openapi_nodes_resp_nodes_inner() override;
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_boot_time getBootTime() const;
    void setBootTime(const OAIV0_0_41_openapi_nodes_resp_nodes_inner_boot_time &boot_time);
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_free_mem getFreeMem() const;
    void setFreeMem(const OAIV0_0_41_openapi_nodes_resp_nodes_inner_free_mem &free_mem);
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_energy getEnergy() const;
    void setEnergy(const OAIV0_0_41_openapi_nodes_resp_nodes_inner_energy &energy);
    bool is_energy_Set() const;
    bool is_energy_Valid() const;

    Q_DECL_DEPRECATED OAIObject getExternalSensors() const;
    Q_DECL_DEPRECATED void setExternalSensors(const OAIObject &external_sensors);
    Q_DECL_DEPRECATED bool is_external_sensors_Set() const;
    Q_DECL_DEPRECATED bool is_external_sensors_Valid() const;
    ...
    Q_DECL_DEPRECATED OAIObject getPower() const;
    Q_DECL_DEPRECATED void setPower(const OAIObject &power);
    Q_DECL_DEPRECATED bool is_power_Set() const;
    Q_DECL_DEPRECATED bool is_power_Valid() const;
    ...
    QString getGpuSpec() const;
    void setGpuSpec(const QString &gpu_spec);
    bool is_gpu_spec_Set() const;
    bool is_gpu_spec_Valid() const;
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_last_busy getLastBusy() const;
    void setLastBusy(const OAIV0_0_41_openapi_nodes_resp_nodes_inner_last_busy &last_busy);
    ...
    qint32 getResCoresPerGpu() const;
    void setResCoresPerGpu(const qint32 &res_cores_per_gpu);
    bool is_res_cores_per_gpu_Set() const;
    bool is_res_cores_per_gpu_Valid() const;
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_reason_changed_at getReasonChangedAt() const;
    void setReasonChangedAt(const OAIV0_0_41_openapi_nodes_resp_nodes_inner_reason_changed_at &reason_changed_at);
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_resume_after getResumeAfter() const;
    void setResumeAfter(const OAIV0_0_41_openapi_nodes_resp_nodes_inner_resume_after &resume_after);
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_slurmd_start_time getSlurmdStartTime() const;
    void setSlurmdStartTime(const OAIV0_0_41_openapi_nodes_resp_nodes_inner_slurmd_start_time &slurmd_start_time);
...
private:
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_boot_time m_boot_time;
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_free_mem m_free_mem;
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_energy m_energy;
    bool m_energy_isSet;
    bool m_energy_isValid;

    OAIObject m_external_sensors;
    ...
    QString m_gpu_spec;
    bool m_gpu_spec_isSet;
    bool m_gpu_spec_isValid;
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_last_busy m_last_busy;
    ...
    qint32 m_res_cores_per_gpu;
    bool m_res_cores_per_gpu_isSet;
    bool m_res_cores_per_gpu_isValid;
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_reason_changed_at m_reason_changed_at;
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_resume_after m_resume_after;
    ...
    OAIV0_0_41_openapi_nodes_resp_nodes_inner_slurmd_start_time m_slurmd_start_time;
