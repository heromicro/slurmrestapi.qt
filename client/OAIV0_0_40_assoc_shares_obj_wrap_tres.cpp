...
OAIV0_0_40_assoc_shares_obj_wrap_tres::OAIV0_0_40_assoc_shares_obj_wrap_tres() {
    this->initializeModel();
}

OAIV0_0_40_assoc_shares_obj_wrap_tres::~OAIV0_0_40_assoc_shares_obj_wrap_tres() {}

void OAIV0_0_40_assoc_shares_obj_wrap_tres::initializeModel() {
...
void OAIV0_0_40_assoc_shares_obj_wrap_tres::fromJson(QString jsonString) {
...
QString OAIV0_0_40_assoc_shares_obj_wrap_tres::asJson() const {
...
QList<OAIV0_0_40_shares_uint64_tres> OAIV0_0_40_assoc_shares_obj_wrap_tres::getRunSeconds() const {
    return m_run_seconds;
}
void OAIV0_0_40_assoc_shares_obj_wrap_tres::setRunSeconds(const QList<OAIV0_0_40_shares_uint64_tres> &run_seconds) {
    m_run_seconds = run_seconds;
    m_run_seconds_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap_tres::is_run_seconds_Set() const{
    return m_run_seconds_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap_tres::is_run_seconds_Valid() const{
    return m_run_seconds_isValid;
}

QList<OAIV0_0_40_shares_uint64_tres> OAIV0_0_40_assoc_shares_obj_wrap_tres::getGroupMinutes() const {
    return m_group_minutes;
}
void OAIV0_0_40_assoc_shares_obj_wrap_tres::setGroupMinutes(const QList<OAIV0_0_40_shares_uint64_tres> &group_minutes) {
    m_group_minutes = group_minutes;
    m_group_minutes_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap_tres::is_group_minutes_Set() const{
    return m_group_minutes_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap_tres::is_group_minutes_Valid() const{
    return m_group_minutes_isValid;
}

QList<OAIV0_0_40_shares_float128_tres> OAIV0_0_40_assoc_shares_obj_wrap_tres::getUsage() const {
    return m_usage;
}
void OAIV0_0_40_assoc_shares_obj_wrap_tres::setUsage(const QList<OAIV0_0_40_shares_float128_tres> &usage) {
    m_usage = usage;
    m_usage_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap_tres::is_usage_Set() const{
    return m_usage_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap_tres::is_usage_Valid() const{
    return m_usage_isValid;
}

bool OAIV0_0_40_assoc_shares_obj_wrap_tres::isSet() const {
...
bool OAIV0_0_40_assoc_shares_obj_wrap_tres::isValid() const {
