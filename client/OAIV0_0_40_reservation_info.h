...
/*
 * OAIV0_0_40_reservation_info.h
 *
 * 
 */

#ifndef OAIV0_0_40_reservation_info_H
#define OAIV0_0_40_reservation_info_H

#include <QJsonObject>

#include "OAIV0_0_40_reservation_core_spec.h"
#include "OAIV0_0_40_reservation_info_purge_completed.h"
...
class OAIV0_0_40_reservation_core_spec;
class OAIV0_0_40_uint64_no_val;
class OAIV0_0_40_reservation_info_purge_completed;
class OAIV0_0_40_uint32_no_val;

class OAIV0_0_40_reservation_info : public OAIObject {
public:
    OAIV0_0_40_reservation_info();
    OAIV0_0_40_reservation_info(QString json);
    ~OAIV0_0_40_reservation_info() override;
    ...
    QList<OAIV0_0_40_reservation_core_spec> getCoreSpecializations() const;
    void setCoreSpecializations(const QList<OAIV0_0_40_reservation_core_spec> &core_specializations);
    ...
    OAIV0_0_40_reservation_info_purge_completed getPurgeCompleted() const;
    void setPurgeCompleted(const OAIV0_0_40_reservation_info_purge_completed &purge_completed);
    ...
    OAIV0_0_40_uint32_no_val getWatts() const;
    void setWatts(const OAIV0_0_40_uint32_no_val &watts);
...
private:
    ...
    QList<OAIV0_0_40_reservation_core_spec> m_core_specializations;
    ...
    OAIV0_0_40_reservation_info_purge_completed m_purge_completed;
    ...
    OAIV0_0_40_uint32_no_val m_watts;
    bool m_watts_isSet;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_40_reservation_info)

#endif // OAIV0_0_40_reservation_info_H
