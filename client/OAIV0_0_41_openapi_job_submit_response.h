...
/*
 * OAIV0_0_41_openapi_job_submit_response.h
 *
 * 
 */

#ifndef OAIV0_0_41_openapi_job_submit_response_H
#define OAIV0_0_41_openapi_job_submit_response_H
...
class OAIV0_0_41_openapi_job_submit_response_result;
...
class OAIV0_0_41_openapi_job_submit_response : public OAIObject {
public:
    OAIV0_0_41_openapi_job_submit_response();
    OAIV0_0_41_openapi_job_submit_response(QString json);
    ~OAIV0_0_41_openapi_job_submit_response() override;
    ...
    Q_DECL_DEPRECATED OAIV0_0_41_openapi_job_submit_response_result getResult() const;
    Q_DECL_DEPRECATED void setResult(const OAIV0_0_41_openapi_job_submit_response_result &result);
    Q_DECL_DEPRECATED bool is_result_Set() const;
    Q_DECL_DEPRECATED bool is_result_Valid() const;
...
private:
    ...
    OAIV0_0_41_openapi_job_submit_response_result m_result;
    bool m_result_isSet;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_41_openapi_job_submit_response)

#endif // OAIV0_0_41_openapi_job_submit_response_H
