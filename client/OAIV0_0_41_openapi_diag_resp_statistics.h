...
/*
 * OAIV0_0_41_openapi_diag_resp_statistics.h
 *
 * statistics
 */

#ifndef OAIV0_0_41_openapi_diag_resp_statistics_H
#define OAIV0_0_41_openapi_diag_resp_statistics_H

#include <QJsonObject>

#include "OAIV0_0_41_openapi_diag_resp_statistics_bf_exit.h"
#include "OAIV0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle.h"
#include "OAIV0_0_41_openapi_diag_resp_statistics_job_states_ts.h"
#include "OAIV0_0_41_openapi_diag_resp_statistics_pending_rpcs_by_hostlist_inner.h"
#include "OAIV0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner.h"
#include "OAIV0_0_41_openapi_diag_resp_statistics_req_time.h"
#include "OAIV0_0_41_openapi_diag_resp_statistics_req_time_start.h"
...
class OAIV0_0_41_openapi_diag_resp_statistics_req_time;
class OAIV0_0_41_openapi_diag_resp_statistics_req_time_start;
class OAIV0_0_41_openapi_diag_resp_statistics_schedule_exit;
class OAIV0_0_41_openapi_diag_resp_statistics_job_states_ts;
class OAIV0_0_41_openapi_diag_resp_statistics_bf_exit;
class OAIV0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle;
class OAIV0_0_41_openapi_diag_resp_statistics_rpcs_by_message_type_inner;
class OAIV0_0_41_openapi_diag_resp_statistics_rpcs_by_user_inner;
class OAIV0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner;
class OAIV0_0_41_openapi_diag_resp_statistics_pending_rpcs_by_hostlist_inner;

class OAIV0_0_41_openapi_diag_resp_statistics : public OAIObject {
public:
    OAIV0_0_41_openapi_diag_resp_statistics();
    OAIV0_0_41_openapi_diag_resp_statistics(QString json);
    ~OAIV0_0_41_openapi_diag_resp_statistics() override;
    ...
    OAIV0_0_41_openapi_diag_resp_statistics_req_time getReqTime() const;
    void setReqTime(const OAIV0_0_41_openapi_diag_resp_statistics_req_time &req_time);
    bool is_req_time_Set() const;
    bool is_req_time_Valid() const;

    OAIV0_0_41_openapi_diag_resp_statistics_req_time_start getReqTimeStart() const;
    void setReqTimeStart(const OAIV0_0_41_openapi_diag_resp_statistics_req_time_start &req_time_start);
    ...
    qint32 getScheduleCycleSum() const;
    void setScheduleCycleSum(const qint32 &schedule_cycle_sum);
    bool is_schedule_cycle_sum_Set() const;
    bool is_schedule_cycle_sum_Valid() const;
    ...
    qint32 getScheduleCycleDepth() const;
    void setScheduleCycleDepth(const qint32 &schedule_cycle_depth);
    bool is_schedule_cycle_depth_Set() const;
    bool is_schedule_cycle_depth_Valid() const;

    OAIV0_0_41_openapi_diag_resp_statistics_schedule_exit getScheduleExit() const;
    void setScheduleExit(const OAIV0_0_41_openapi_diag_resp_statistics_schedule_exit &schedule_exit);
    bool is_schedule_exit_Set() const;
    bool is_schedule_exit_Valid() const;
    ...
    OAIV0_0_41_openapi_diag_resp_statistics_job_states_ts getJobStatesTs() const;
    void setJobStatesTs(const OAIV0_0_41_openapi_diag_resp_statistics_job_states_ts &job_states_ts);
    ...
    qint32 getBfCycleMax() const;
    void setBfCycleMax(const qint32 &bf_cycle_max);
    bool is_bf_cycle_max_Set() const;
    bool is_bf_cycle_max_Valid() const;

    OAIV0_0_41_openapi_diag_resp_statistics_bf_exit getBfExit() const;
    void setBfExit(const OAIV0_0_41_openapi_diag_resp_statistics_bf_exit &bf_exit);
    bool is_bf_exit_Set() const;
    bool is_bf_exit_Valid() const;
    ...
    qint32 getBfTableSizeSum() const;
    void setBfTableSizeSum(const qint32 &bf_table_size_sum);
    bool is_bf_table_size_sum_Set() const;
    bool is_bf_table_size_sum_Valid() const;
    ...
    OAIV0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle getBfWhenLastCycle() const;
    void setBfWhenLastCycle(const OAIV0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle &bf_when_last_cycle);
    ...
    QList<OAIV0_0_41_openapi_diag_resp_statistics_rpcs_by_message_type_inner> getRpcsByMessageType() const;
    void setRpcsByMessageType(const QList<OAIV0_0_41_openapi_diag_resp_statistics_rpcs_by_message_type_inner> &rpcs_by_message_type);
    bool is_rpcs_by_message_type_Set() const;
    bool is_rpcs_by_message_type_Valid() const;

    QList<OAIV0_0_41_openapi_diag_resp_statistics_rpcs_by_user_inner> getRpcsByUser() const;
    void setRpcsByUser(const QList<OAIV0_0_41_openapi_diag_resp_statistics_rpcs_by_user_inner> &rpcs_by_user);
    bool is_rpcs_by_user_Set() const;
    bool is_rpcs_by_user_Valid() const;

    QList<OAIV0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner> getPendingRpcs() const;
    void setPendingRpcs(const QList<OAIV0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner> &pending_rpcs);
    bool is_pending_rpcs_Set() const;
    bool is_pending_rpcs_Valid() const;

    QList<OAIV0_0_41_openapi_diag_resp_statistics_pending_rpcs_by_hostlist_inner> getPendingRpcsByHostlist() const;
    void setPendingRpcsByHostlist(const QList<OAIV0_0_41_openapi_diag_resp_statistics_pending_rpcs_by_hostlist_inner> &pending_rpcs_by_hostlist);
    bool is_pending_rpcs_by_hostlist_Set() const;
    bool is_pending_rpcs_by_hostlist_Valid() const;
...
private:
    ...
    OAIV0_0_41_openapi_diag_resp_statistics_req_time m_req_time;
    bool m_req_time_isSet;
    bool m_req_time_isValid;

    OAIV0_0_41_openapi_diag_resp_statistics_req_time_start m_req_time_start;
    ...
    qint32 m_schedule_cycle_sum;
    bool m_schedule_cycle_sum_isSet;
    bool m_schedule_cycle_sum_isValid;
    ...
    qint32 m_schedule_cycle_depth;
    bool m_schedule_cycle_depth_isSet;
    bool m_schedule_cycle_depth_isValid;

    OAIV0_0_41_openapi_diag_resp_statistics_schedule_exit m_schedule_exit;
    bool m_schedule_exit_isSet;
    bool m_schedule_exit_isValid;
    ...
    OAIV0_0_41_openapi_diag_resp_statistics_job_states_ts m_job_states_ts;
    ...
    qint32 m_bf_cycle_max;
    bool m_bf_cycle_max_isSet;
    bool m_bf_cycle_max_isValid;

    OAIV0_0_41_openapi_diag_resp_statistics_bf_exit m_bf_exit;
    bool m_bf_exit_isSet;
    bool m_bf_exit_isValid;
    ...
    qint32 m_bf_table_size_sum;
    bool m_bf_table_size_sum_isSet;
    bool m_bf_table_size_sum_isValid;

    qint64 m_bf_table_size_mean;
    bool m_bf_table_size_mean_isSet;
    bool m_bf_table_size_mean_isValid;

    OAIV0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle m_bf_when_last_cycle;
    ...
    QList<OAIV0_0_41_openapi_diag_resp_statistics_rpcs_by_message_type_inner> m_rpcs_by_message_type;
    bool m_rpcs_by_message_type_isSet;
    bool m_rpcs_by_message_type_isValid;

    QList<OAIV0_0_41_openapi_diag_resp_statistics_rpcs_by_user_inner> m_rpcs_by_user;
    bool m_rpcs_by_user_isSet;
    bool m_rpcs_by_user_isValid;

    QList<OAIV0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner> m_pending_rpcs;
    bool m_pending_rpcs_isSet;
    bool m_pending_rpcs_isValid;

    QList<OAIV0_0_41_openapi_diag_resp_statistics_pending_rpcs_by_hostlist_inner> m_pending_rpcs_by_hostlist;
    bool m_pending_rpcs_by_hostlist_isSet;
    bool m_pending_rpcs_by_hostlist_isValid;
};

} // namespace hm:slurm:client

Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_41_openapi_diag_resp_statistics)

#endif // OAIV0_0_41_openapi_diag_resp_statistics_H
