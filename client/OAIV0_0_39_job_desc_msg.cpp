...
QList<QString> OAIV0_0_39_job_desc_msg::getPowerFlags() const {
    return m_power_flags;
}
void OAIV0_0_39_job_desc_msg::setPowerFlags(const QList<QString> &power_flags) {
...
qint32 OAIV0_0_39_job_desc_msg::getPriority() const {
    return m_priority;
}
void OAIV0_0_39_job_desc_msg::setPriority(const qint32 &priority) {
    m_priority = priority;
