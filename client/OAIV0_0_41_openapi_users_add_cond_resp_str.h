...
/*
 * OAIV0_0_41_openapi_users_add_cond_resp_str.h
 *
 * 
 */

#ifndef OAIV0_0_41_openapi_users_add_cond_resp_str_H
#define OAIV0_0_41_openapi_users_add_cond_resp_str_H
...
class OAIV0_0_41_openapi_users_add_cond_resp_str : public OAIObject {
public:
    OAIV0_0_41_openapi_users_add_cond_resp_str();
    OAIV0_0_41_openapi_users_add_cond_resp_str(QString json);
    ~OAIV0_0_41_openapi_users_add_cond_resp_str() override;
    ...
    QString getAddedUsers() const;
    void setAddedUsers(const QString &added_users);
    bool is_added_users_Set() const;
    bool is_added_users_Valid() const;
...
private:
    ...
    QString m_added_users;
    bool m_added_users_isSet;
    bool m_added_users_isValid;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_41_openapi_users_add_cond_resp_str)

#endif // OAIV0_0_41_openapi_users_add_cond_resp_str_H
