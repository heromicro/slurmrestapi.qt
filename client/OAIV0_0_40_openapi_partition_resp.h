...
/*
 * OAIV0_0_40_openapi_partition_resp.h
 *
 * 
 */

#ifndef OAIV0_0_40_openapi_partition_resp_H
#define OAIV0_0_40_openapi_partition_resp_H
...
class OAIV0_0_40_openapi_partition_resp : public OAIObject {
public:
    OAIV0_0_40_openapi_partition_resp();
    OAIV0_0_40_openapi_partition_resp(QString json);
    ~OAIV0_0_40_openapi_partition_resp() override;
    ...
    QList<OAIV0_0_40_partition_info> getPartitions() const;
    void setPartitions(const QList<OAIV0_0_40_partition_info> &partitions);
...
private:
    ...
    QList<OAIV0_0_40_partition_info> m_partitions;
