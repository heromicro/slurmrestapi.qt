...
/*
 * OAIV0_0_40_openapi_accounts_add_cond_resp.h
 *
 * 
 */

#ifndef OAIV0_0_40_openapi_accounts_add_cond_resp_H
#define OAIV0_0_40_openapi_accounts_add_cond_resp_H
...
class OAIV0_0_40_accounts_add_cond;
class OAIV0_0_40_account_short;
class OAIV0_0_40_openapi_meta;
class OAIV0_0_40_openapi_error;
class OAIV0_0_40_openapi_warning;

class OAIV0_0_40_openapi_accounts_add_cond_resp : public OAIObject {
public:
    OAIV0_0_40_openapi_accounts_add_cond_resp();
    OAIV0_0_40_openapi_accounts_add_cond_resp(QString json);
    ~OAIV0_0_40_openapi_accounts_add_cond_resp() override;
    ...
    OAIV0_0_40_accounts_add_cond getAssociationCondition() const;
    void setAssociationCondition(const OAIV0_0_40_accounts_add_cond &association_condition);
    bool is_association_condition_Set() const;
    bool is_association_condition_Valid() const;

    OAIV0_0_40_account_short getAccount() const;
    void setAccount(const OAIV0_0_40_account_short &account);
...
private:
    ...
    OAIV0_0_40_accounts_add_cond m_association_condition;
    bool m_association_condition_isSet;
    bool m_association_condition_isValid;

    OAIV0_0_40_account_short m_account;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_40_openapi_accounts_add_cond_resp)

#endif // OAIV0_0_40_openapi_accounts_add_cond_resp_H
