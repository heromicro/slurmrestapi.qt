...
/*
 * OAIV0_0_40_openapi_slurmdbd_jobs_resp.h
 *
 * 
 */

#ifndef OAIV0_0_40_openapi_slurmdbd_jobs_resp_H
#define OAIV0_0_40_openapi_slurmdbd_jobs_resp_H
...
class OAIV0_0_40_job;
class OAIV0_0_40_openapi_meta;
class OAIV0_0_40_openapi_error;
class OAIV0_0_40_openapi_warning;

class OAIV0_0_40_openapi_slurmdbd_jobs_resp : public OAIObject {
public:
    OAIV0_0_40_openapi_slurmdbd_jobs_resp();
    OAIV0_0_40_openapi_slurmdbd_jobs_resp(QString json);
    ~OAIV0_0_40_openapi_slurmdbd_jobs_resp() override;
    ...
    QList<OAIV0_0_40_job> getJobs() const;
    void setJobs(const QList<OAIV0_0_40_job> &jobs);
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_40_openapi_slurmdbd_jobs_resp)

#endif // OAIV0_0_40_openapi_slurmdbd_jobs_resp_H
