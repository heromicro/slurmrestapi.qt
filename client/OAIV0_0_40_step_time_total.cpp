...
OAIV0_0_40_step_time_total::OAIV0_0_40_step_time_total() {
    this->initializeModel();
}

OAIV0_0_40_step_time_total::~OAIV0_0_40_step_time_total() {}

void OAIV0_0_40_step_time_total::initializeModel() {
...
void OAIV0_0_40_step_time_total::fromJson(QString jsonString) {
...
QString OAIV0_0_40_step_time_total::asJson() const {
...
qint64 OAIV0_0_40_step_time_total::getSeconds() const {
    return m_seconds;
}
void OAIV0_0_40_step_time_total::setSeconds(const qint64 &seconds) {
    m_seconds = seconds;
    m_seconds_isSet = true;
}

bool OAIV0_0_40_step_time_total::is_seconds_Set() const{
    return m_seconds_isSet;
}

bool OAIV0_0_40_step_time_total::is_seconds_Valid() const{
    return m_seconds_isValid;
}

qint32 OAIV0_0_40_step_time_total::getMicroseconds() const {
    return m_microseconds;
}
void OAIV0_0_40_step_time_total::setMicroseconds(const qint32 &microseconds) {
    m_microseconds = microseconds;
    m_microseconds_isSet = true;
}

bool OAIV0_0_40_step_time_total::is_microseconds_Set() const{
    return m_microseconds_isSet;
}

bool OAIV0_0_40_step_time_total::is_microseconds_Valid() const{
    return m_microseconds_isValid;
}

bool OAIV0_0_40_step_time_total::isSet() const {
...
bool OAIV0_0_40_step_time_total::isValid() const {
