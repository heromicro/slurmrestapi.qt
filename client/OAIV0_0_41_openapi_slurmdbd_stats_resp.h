...
/*
 * OAIV0_0_41_openapi_slurmdbd_stats_resp.h
 *
 * 
 */

#ifndef OAIV0_0_41_openapi_slurmdbd_stats_resp_H
#define OAIV0_0_41_openapi_slurmdbd_stats_resp_H
...
class OAIV0_0_41_openapi_slurmdbd_stats_resp_statistics;
...
class OAIV0_0_41_openapi_slurmdbd_stats_resp : public OAIObject {
public:
    OAIV0_0_41_openapi_slurmdbd_stats_resp();
    OAIV0_0_41_openapi_slurmdbd_stats_resp(QString json);
    ~OAIV0_0_41_openapi_slurmdbd_stats_resp() override;
    ...
    OAIV0_0_41_openapi_slurmdbd_stats_resp_statistics getStatistics() const;
    void setStatistics(const OAIV0_0_41_openapi_slurmdbd_stats_resp_statistics &statistics);
...
private:
    ...
    OAIV0_0_41_openapi_slurmdbd_stats_resp_statistics m_statistics;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_41_openapi_slurmdbd_stats_resp)

#endif // OAIV0_0_41_openapi_slurmdbd_stats_resp_H
