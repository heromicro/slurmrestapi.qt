...
#ifndef OAIDbv0_0_39_job_info_H
#define OAIDbv0_0_39_job_info_H
...
class OAIV0_0_39_job;

class OAIDbv0_0_39_job_info : public OAIObject {
public:
    OAIDbv0_0_39_job_info();
    OAIDbv0_0_39_job_info(QString json);
    ~OAIDbv0_0_39_job_info() override;
    ...
    QList<OAIV0_0_39_job> getJobs() const;
    void setJobs(const QList<OAIV0_0_39_job> &jobs);
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIDbv0_0_39_job_info)

#endif // OAIDbv0_0_39_job_info_H
