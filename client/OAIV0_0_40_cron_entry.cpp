...
#include "OAIV0_0_40_cron_entry.h"
...
OAIV0_0_40_cron_entry::OAIV0_0_40_cron_entry() {
    this->initializeModel();
}

OAIV0_0_40_cron_entry::~OAIV0_0_40_cron_entry() {}

void OAIV0_0_40_cron_entry::initializeModel() {
...
void OAIV0_0_40_cron_entry::fromJson(QString jsonString) {
...
QString OAIV0_0_40_cron_entry::asJson() const {
...
QList<QString> OAIV0_0_40_cron_entry::getFlags() const {
    return m_flags;
}
void OAIV0_0_40_cron_entry::setFlags(const QList<QString> &flags) {
    m_flags = flags;
    m_flags_isSet = true;
}

bool OAIV0_0_40_cron_entry::is_flags_Set() const{
    return m_flags_isSet;
}

bool OAIV0_0_40_cron_entry::is_flags_Valid() const{
    return m_flags_isValid;
}

QString OAIV0_0_40_cron_entry::getMinute() const {
    return m_minute;
}
void OAIV0_0_40_cron_entry::setMinute(const QString &minute) {
    m_minute = minute;
    m_minute_isSet = true;
}

bool OAIV0_0_40_cron_entry::is_minute_Set() const{
    return m_minute_isSet;
}

bool OAIV0_0_40_cron_entry::is_minute_Valid() const{
    return m_minute_isValid;
}

QString OAIV0_0_40_cron_entry::getHour() const {
    return m_hour;
}
void OAIV0_0_40_cron_entry::setHour(const QString &hour) {
    m_hour = hour;
    m_hour_isSet = true;
}

bool OAIV0_0_40_cron_entry::is_hour_Set() const{
    return m_hour_isSet;
}

bool OAIV0_0_40_cron_entry::is_hour_Valid() const{
    return m_hour_isValid;
}

QString OAIV0_0_40_cron_entry::getDayOfMonth() const {
    return m_day_of_month;
}
void OAIV0_0_40_cron_entry::setDayOfMonth(const QString &day_of_month) {
    m_day_of_month = day_of_month;
    m_day_of_month_isSet = true;
}

bool OAIV0_0_40_cron_entry::is_day_of_month_Set() const{
    return m_day_of_month_isSet;
}

bool OAIV0_0_40_cron_entry::is_day_of_month_Valid() const{
    return m_day_of_month_isValid;
}

QString OAIV0_0_40_cron_entry::getMonth() const {
    return m_month;
}
void OAIV0_0_40_cron_entry::setMonth(const QString &month) {
    m_month = month;
    m_month_isSet = true;
}

bool OAIV0_0_40_cron_entry::is_month_Set() const{
    return m_month_isSet;
}

bool OAIV0_0_40_cron_entry::is_month_Valid() const{
    return m_month_isValid;
}

QString OAIV0_0_40_cron_entry::getDayOfWeek() const {
    return m_day_of_week;
}
void OAIV0_0_40_cron_entry::setDayOfWeek(const QString &day_of_week) {
    m_day_of_week = day_of_week;
    m_day_of_week_isSet = true;
}

bool OAIV0_0_40_cron_entry::is_day_of_week_Set() const{
    return m_day_of_week_isSet;
}

bool OAIV0_0_40_cron_entry::is_day_of_week_Valid() const{
    return m_day_of_week_isValid;
}

QString OAIV0_0_40_cron_entry::getSpecification() const {
    return m_specification;
}
void OAIV0_0_40_cron_entry::setSpecification(const QString &specification) {
    m_specification = specification;
    m_specification_isSet = true;
}

bool OAIV0_0_40_cron_entry::is_specification_Set() const{
    return m_specification_isSet;
}

bool OAIV0_0_40_cron_entry::is_specification_Valid() const{
    return m_specification_isValid;
}

QString OAIV0_0_40_cron_entry::getCommand() const {
    return m_command;
}
void OAIV0_0_40_cron_entry::setCommand(const QString &command) {
    m_command = command;
    m_command_isSet = true;
}

bool OAIV0_0_40_cron_entry::is_command_Set() const{
    return m_command_isSet;
}

bool OAIV0_0_40_cron_entry::is_command_Valid() const{
    return m_command_isValid;
}

OAIV0_0_40_cron_entry_line OAIV0_0_40_cron_entry::getLine() const {
    return m_line;
}
void OAIV0_0_40_cron_entry::setLine(const OAIV0_0_40_cron_entry_line &line) {
    m_line = line;
    m_line_isSet = true;
}

bool OAIV0_0_40_cron_entry::is_line_Set() const{
    return m_line_isSet;
}

bool OAIV0_0_40_cron_entry::is_line_Valid() const{
    return m_line_isValid;
}

bool OAIV0_0_40_cron_entry::isSet() const {
...
bool OAIV0_0_40_cron_entry::isValid() const {
