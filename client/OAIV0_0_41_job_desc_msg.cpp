...
void OAIV0_0_41_job_desc_msg::fromJsonObject(QJsonObject json) {
    ...
    m_rlimits_isValid = ::OpenAPI::fromJsonValue(m_rlimits, json[QString("rlimits")]);
    ...
    m_resv_mpi_ports_isValid = ::OpenAPI::fromJsonValue(m_resv_mpi_ports, json[QString("resv_mpi_ports")]);
    ...
    m_segment_size_isValid = ::OpenAPI::fromJsonValue(m_segment_size, json[QString("segment_size")]);
...
QJsonObject OAIV0_0_41_job_desc_msg::asJsonObject() const {
    ...
    if (m_rlimits.isSet()) {
        obj.insert(QString("rlimits"), ::OpenAPI::toJsonValue(m_rlimits));
    }
    ...
    if (m_resv_mpi_ports_isSet) {
        obj.insert(QString("resv_mpi_ports"), ::OpenAPI::toJsonValue(m_resv_mpi_ports));
    }
    if (m_script_isSet) {
    ...
    if (m_segment_size.isSet()) {
        obj.insert(QString("segment_size"), ::OpenAPI::toJsonValue(m_segment_size));
    }
