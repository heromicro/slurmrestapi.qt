...
/*
 * OAIV0_0_40_openapi_shares_resp.h
 *
 * 
 */

#ifndef OAIV0_0_40_openapi_shares_resp_H
#define OAIV0_0_40_openapi_shares_resp_H
...
class OAIV0_0_40_shares_resp_msg;
class OAIV0_0_40_openapi_meta;
class OAIV0_0_40_openapi_error;
class OAIV0_0_40_openapi_warning;

class OAIV0_0_40_openapi_shares_resp : public OAIObject {
public:
    OAIV0_0_40_openapi_shares_resp();
    OAIV0_0_40_openapi_shares_resp(QString json);
    ~OAIV0_0_40_openapi_shares_resp() override;
    ...
    OAIV0_0_40_shares_resp_msg getShares() const;
    void setShares(const OAIV0_0_40_shares_resp_msg &shares);
...
private:
    ...
    OAIV0_0_40_shares_resp_msg m_shares;
    bool m_shares_isSet;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_40_openapi_shares_resp)

#endif // OAIV0_0_40_openapi_shares_resp_H
