...
OAIV0_0_40_assoc_shares_obj_wrap::OAIV0_0_40_assoc_shares_obj_wrap() {
    this->initializeModel();
}

OAIV0_0_40_assoc_shares_obj_wrap::~OAIV0_0_40_assoc_shares_obj_wrap() {}

void OAIV0_0_40_assoc_shares_obj_wrap::initializeModel() {
...
void OAIV0_0_40_assoc_shares_obj_wrap::fromJson(QString jsonString) {
...
QString OAIV0_0_40_assoc_shares_obj_wrap::asJson() const {
...
qint32 OAIV0_0_40_assoc_shares_obj_wrap::getId() const {
    return m_id;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setId(const qint32 &id) {
    m_id = id;
    m_id_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_id_Set() const{
    return m_id_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_id_Valid() const{
    return m_id_isValid;
}

QString OAIV0_0_40_assoc_shares_obj_wrap::getCluster() const {
    return m_cluster;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setCluster(const QString &cluster) {
    m_cluster = cluster;
    m_cluster_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_cluster_Set() const{
    return m_cluster_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_cluster_Valid() const{
    return m_cluster_isValid;
}

QString OAIV0_0_40_assoc_shares_obj_wrap::getName() const {
    return m_name;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setName(const QString &name) {
    m_name = name;
    m_name_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_name_Set() const{
    return m_name_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_name_Valid() const{
    return m_name_isValid;
}

QString OAIV0_0_40_assoc_shares_obj_wrap::getParent() const {
    return m_parent;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setParent(const QString &parent) {
    m_parent = parent;
    m_parent_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_parent_Set() const{
    return m_parent_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_parent_Valid() const{
    return m_parent_isValid;
}

QString OAIV0_0_40_assoc_shares_obj_wrap::getPartition() const {
    return m_partition;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setPartition(const QString &partition) {
    m_partition = partition;
    m_partition_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_partition_Set() const{
    return m_partition_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_partition_Valid() const{
    return m_partition_isValid;
}

OAIV0_0_40_float64_no_val OAIV0_0_40_assoc_shares_obj_wrap::getSharesNormalized() const {
    return m_shares_normalized;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setSharesNormalized(const OAIV0_0_40_float64_no_val &shares_normalized) {
    m_shares_normalized = shares_normalized;
    m_shares_normalized_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_shares_normalized_Set() const{
    return m_shares_normalized_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_shares_normalized_Valid() const{
    return m_shares_normalized_isValid;
}

OAIV0_0_40_uint32_no_val OAIV0_0_40_assoc_shares_obj_wrap::getShares() const {
    return m_shares;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setShares(const OAIV0_0_40_uint32_no_val &shares) {
    m_shares = shares;
    m_shares_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_shares_Set() const{
    return m_shares_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_shares_Valid() const{
    return m_shares_isValid;
}

OAIV0_0_40_assoc_shares_obj_wrap_tres OAIV0_0_40_assoc_shares_obj_wrap::getTres() const {
    return m_tres;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setTres(const OAIV0_0_40_assoc_shares_obj_wrap_tres &tres) {
    m_tres = tres;
    m_tres_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_tres_Set() const{
    return m_tres_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_tres_Valid() const{
    return m_tres_isValid;
}

double OAIV0_0_40_assoc_shares_obj_wrap::getEffectiveUsage() const {
    return m_effective_usage;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setEffectiveUsage(const double &effective_usage) {
    m_effective_usage = effective_usage;
    m_effective_usage_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_effective_usage_Set() const{
    return m_effective_usage_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_effective_usage_Valid() const{
    return m_effective_usage_isValid;
}

OAIV0_0_40_float64_no_val OAIV0_0_40_assoc_shares_obj_wrap::getUsageNormalized() const {
    return m_usage_normalized;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setUsageNormalized(const OAIV0_0_40_float64_no_val &usage_normalized) {
    m_usage_normalized = usage_normalized;
    m_usage_normalized_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_usage_normalized_Set() const{
    return m_usage_normalized_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_usage_normalized_Valid() const{
    return m_usage_normalized_isValid;
}

qint64 OAIV0_0_40_assoc_shares_obj_wrap::getUsage() const {
    return m_usage;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setUsage(const qint64 &usage) {
    m_usage = usage;
    m_usage_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_usage_Set() const{
    return m_usage_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_usage_Valid() const{
    return m_usage_isValid;
}

OAIV0_0_40_assoc_shares_obj_wrap_fairshare OAIV0_0_40_assoc_shares_obj_wrap::getFairshare() const {
    return m_fairshare;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setFairshare(const OAIV0_0_40_assoc_shares_obj_wrap_fairshare &fairshare) {
    m_fairshare = fairshare;
    m_fairshare_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_fairshare_Set() const{
    return m_fairshare_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_fairshare_Valid() const{
    return m_fairshare_isValid;
}

QList<QString> OAIV0_0_40_assoc_shares_obj_wrap::getType() const {
    return m_type;
}
void OAIV0_0_40_assoc_shares_obj_wrap::setType(const QList<QString> &type) {
    m_type = type;
    m_type_isSet = true;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_type_Set() const{
    return m_type_isSet;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::is_type_Valid() const{
    return m_type_isValid;
}

bool OAIV0_0_40_assoc_shares_obj_wrap::isSet() const {
...
bool OAIV0_0_40_assoc_shares_obj_wrap::isValid() const {
