...
/*
 * OAIV0_0_41_openapi_kill_jobs_resp_status_inner.h
 *
 * List of jobs signal responses
 */

#ifndef OAIV0_0_41_openapi_kill_jobs_resp_status_inner_H
#define OAIV0_0_41_openapi_kill_jobs_resp_status_inner_H
...
class OAIV0_0_41_openapi_kill_jobs_resp_status_inner_job_id;
class OAIV0_0_40_kill_jobs_resp_job_federation;

class OAIV0_0_41_openapi_kill_jobs_resp_status_inner : public OAIObject {
public:
    OAIV0_0_41_openapi_kill_jobs_resp_status_inner();
    OAIV0_0_41_openapi_kill_jobs_resp_status_inner(QString json);
    ~OAIV0_0_41_openapi_kill_jobs_resp_status_inner() override;
    ...
    OAIV0_0_41_openapi_kill_jobs_resp_status_inner_job_id getJobId() const;
    void setJobId(const OAIV0_0_41_openapi_kill_jobs_resp_status_inner_job_id &job_id);
...
private:
    ...
    OAIV0_0_41_openapi_kill_jobs_resp_status_inner_job_id m_job_id;
    bool m_job_id_isSet;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_41_openapi_kill_jobs_resp_status_inner)

#endif // OAIV0_0_41_openapi_kill_jobs_resp_status_inner_H
