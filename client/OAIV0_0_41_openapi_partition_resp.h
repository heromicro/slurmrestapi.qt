...
/*
 * OAIV0_0_41_openapi_partition_resp.h
 *
 * 
 */

#ifndef OAIV0_0_41_openapi_partition_resp_H
#define OAIV0_0_41_openapi_partition_resp_H
...
class OAIV0_0_41_openapi_partition_resp_partitions_inner;
class OAIV0_0_41_openapi_partition_resp_last_update;
...
class OAIV0_0_41_openapi_partition_resp : public OAIObject {
public:
    OAIV0_0_41_openapi_partition_resp();
    OAIV0_0_41_openapi_partition_resp(QString json);
    ~OAIV0_0_41_openapi_partition_resp() override;
    ...
    QList<OAIV0_0_41_openapi_partition_resp_partitions_inner> getPartitions() const;
    void setPartitions(const QList<OAIV0_0_41_openapi_partition_resp_partitions_inner> &partitions);
    bool is_partitions_Set() const;
    bool is_partitions_Valid() const;

    OAIV0_0_41_openapi_partition_resp_last_update getLastUpdate() const;
    void setLastUpdate(const OAIV0_0_41_openapi_partition_resp_last_update &last_update);
...
private:
    ...
    QList<OAIV0_0_41_openapi_partition_resp_partitions_inner> m_partitions;
    bool m_partitions_isSet;
    bool m_partitions_isValid;

    OAIV0_0_41_openapi_partition_resp_last_update m_last_update;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_41_openapi_partition_resp)

#endif // OAIV0_0_41_openapi_partition_resp_H
