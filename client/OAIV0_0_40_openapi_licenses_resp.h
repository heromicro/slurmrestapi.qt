...
/*
 * OAIV0_0_40_openapi_licenses_resp.h
 *
 * 
 */

#ifndef OAIV0_0_40_openapi_licenses_resp_H
#define OAIV0_0_40_openapi_licenses_resp_H
...
class OAIV0_0_40_openapi_licenses_resp : public OAIObject {
public:
    OAIV0_0_40_openapi_licenses_resp();
    OAIV0_0_40_openapi_licenses_resp(QString json);
    ~OAIV0_0_40_openapi_licenses_resp() override;
    ...
    QList<OAIV0_0_40_license> getLicenses() const;
    void setLicenses(const QList<OAIV0_0_40_license> &licenses);
...
private:
    ...
    QList<OAIV0_0_40_license> m_licenses;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_40_openapi_licenses_resp)

#endif // OAIV0_0_40_openapi_licenses_resp_H
