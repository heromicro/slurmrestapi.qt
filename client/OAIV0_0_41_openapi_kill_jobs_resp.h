...
/*
 * OAIV0_0_41_openapi_kill_jobs_resp.h
 *
 * 
 */

#ifndef OAIV0_0_41_openapi_kill_jobs_resp_H
#define OAIV0_0_41_openapi_kill_jobs_resp_H
...
class OAIV0_0_41_openapi_kill_jobs_resp_status_inner;
...
class OAIV0_0_41_openapi_kill_jobs_resp : public OAIObject {
public:
    OAIV0_0_41_openapi_kill_jobs_resp();
    OAIV0_0_41_openapi_kill_jobs_resp(QString json);
    ~OAIV0_0_41_openapi_kill_jobs_resp() override;
    ...
    QList<OAIV0_0_41_openapi_kill_jobs_resp_status_inner> getStatus() const;
    void setStatus(const QList<OAIV0_0_41_openapi_kill_jobs_resp_status_inner> &status);
...
private:
    ...
    QList<OAIV0_0_41_openapi_kill_jobs_resp_status_inner> m_status;
    bool m_status_isSet;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_41_openapi_kill_jobs_resp)

#endif // OAIV0_0_41_openapi_kill_jobs_resp_H
