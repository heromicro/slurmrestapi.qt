...
OAIV0_0_39_uint32_no_val OAIV0_0_39_qos_limits_min::getPriorityThreshold() const {
    return m_priority_threshold;
}
void OAIV0_0_39_qos_limits_min::setPriorityThreshold(const OAIV0_0_39_uint32_no_val &priority_threshold) {
    m_priority_threshold = priority_threshold;
    m_priority_threshold_isSet = true;
}

bool OAIV0_0_39_qos_limits_min::is_priority_threshold_Set() const{
    return m_priority_threshold_isSet;
}

bool OAIV0_0_39_qos_limits_min::is_priority_threshold_Valid() const{
