...
OAIV0_0_39_job_res::OAIV0_0_39_job_res() {
    this->initializeModel();
}

OAIV0_0_39_job_res::~OAIV0_0_39_job_res() {}

void OAIV0_0_39_job_res::initializeModel() {
...
void OAIV0_0_39_job_res::fromJson(QString jsonString) {
...
QString OAIV0_0_39_job_res::asJson() const {
...
QString OAIV0_0_39_job_res::getNodes() const {
    return m_nodes;
}
void OAIV0_0_39_job_res::setNodes(const QString &nodes) {
    m_nodes = nodes;
    m_nodes_isSet = true;
}

bool OAIV0_0_39_job_res::is_nodes_Set() const{
    return m_nodes_isSet;
}

bool OAIV0_0_39_job_res::is_nodes_Valid() const{
    return m_nodes_isValid;
}

qint32 OAIV0_0_39_job_res::getAllocatedCores() const {
    return m_allocated_cores;
}
void OAIV0_0_39_job_res::setAllocatedCores(const qint32 &allocated_cores) {
    m_allocated_cores = allocated_cores;
    m_allocated_cores_isSet = true;
}

bool OAIV0_0_39_job_res::is_allocated_cores_Set() const{
    return m_allocated_cores_isSet;
}

bool OAIV0_0_39_job_res::is_allocated_cores_Valid() const{
    return m_allocated_cores_isValid;
}

qint32 OAIV0_0_39_job_res::getAllocatedCpus() const {
    return m_allocated_cpus;
}
void OAIV0_0_39_job_res::setAllocatedCpus(const qint32 &allocated_cpus) {
    m_allocated_cpus = allocated_cpus;
    m_allocated_cpus_isSet = true;
}

bool OAIV0_0_39_job_res::is_allocated_cpus_Set() const{
    return m_allocated_cpus_isSet;
}

bool OAIV0_0_39_job_res::is_allocated_cpus_Valid() const{
    return m_allocated_cpus_isValid;
}

qint32 OAIV0_0_39_job_res::getAllocatedHosts() const {
    return m_allocated_hosts;
}
void OAIV0_0_39_job_res::setAllocatedHosts(const qint32 &allocated_hosts) {
    m_allocated_hosts = allocated_hosts;
    m_allocated_hosts_isSet = true;
}

bool OAIV0_0_39_job_res::is_allocated_hosts_Set() const{
    return m_allocated_hosts_isSet;
}

bool OAIV0_0_39_job_res::is_allocated_hosts_Valid() const{
    return m_allocated_hosts_isValid;
}

QList<QJsonValue> OAIV0_0_39_job_res::getAllocatedNodes() const {
    return m_allocated_nodes;
}
void OAIV0_0_39_job_res::setAllocatedNodes(const QList<QJsonValue> &allocated_nodes) {
    m_allocated_nodes = allocated_nodes;
    m_allocated_nodes_isSet = true;
}

bool OAIV0_0_39_job_res::is_allocated_nodes_Set() const{
    return m_allocated_nodes_isSet;
}

bool OAIV0_0_39_job_res::is_allocated_nodes_Valid() const{
    return m_allocated_nodes_isValid;
}

bool OAIV0_0_39_job_res::isSet() const {
...
bool OAIV0_0_39_job_res::isValid() const {
