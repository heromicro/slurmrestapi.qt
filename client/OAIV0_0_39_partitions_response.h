...
#ifndef OAIV0_0_39_partitions_response_H
#define OAIV0_0_39_partitions_response_H
...
class OAIV0_0_39_partition_info;

class OAIV0_0_39_partitions_response : public OAIObject {
public:
    OAIV0_0_39_partitions_response();
    OAIV0_0_39_partitions_response(QString json);
    ~OAIV0_0_39_partitions_response() override;
    ...
    QList<OAIV0_0_39_partition_info> getPartitions() const;
    void setPartitions(const QList<OAIV0_0_39_partition_info> &partitions);
...
private:
    ...
    QList<OAIV0_0_39_partition_info> m_partitions;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_39_partitions_response)

#endif // OAIV0_0_39_partitions_response_H
