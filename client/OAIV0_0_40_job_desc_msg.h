...
/*
 * OAIV0_0_40_job_desc_msg.h
 *
 * 
 */

#ifndef OAIV0_0_40_job_desc_msg_H
#define OAIV0_0_40_job_desc_msg_H
...
class OAIV0_0_40_job_desc_msg : public OAIObject {
public:
    OAIV0_0_40_job_desc_msg();
    OAIV0_0_40_job_desc_msg(QString json);
    ~OAIV0_0_40_job_desc_msg() override;
    ...
    OAIV0_0_40_uint64_no_val getBeginTime() const;
    void setBeginTime(const OAIV0_0_40_uint64_no_val &begin_time);
    ...
    qint32 getCoresPerSocket() const;
    void setCoresPerSocket(const qint32 &cores_per_socket);
    ...
    OAIV0_0_40_cron_entry getCrontab() const;
    void setCrontab(const OAIV0_0_40_cron_entry &crontab);
    ...
    OAIV0_0_40_job_desc_msg_rlimits getRlimits() const;
    void setRlimits(const OAIV0_0_40_job_desc_msg_rlimits &rlimits);
    ...
    qint32 getDistributionPlaneSize() const;
    void setDistributionPlaneSize(const qint32 &distribution_plane_size);
    ...
    OAIV0_0_40_uint16_no_val getKillWarningDelay() const;
    void setKillWarningDelay(const OAIV0_0_40_uint16_no_val &kill_warning_delay);
    ...
    OAIV0_0_40_uint32_no_val getRequiredSwitches() const;
    void setRequiredSwitches(const OAIV0_0_40_uint32_no_val &required_switches);
...
private:
    ...
    OAIV0_0_40_uint64_no_val m_begin_time;
    ...
    OAIV0_0_40_cron_entry m_crontab;
    ...
    OAIV0_0_40_job_desc_msg_rlimits m_rlimits;
    ...
    qint32 m_distribution_plane_size;
    ...
    OAIV0_0_40_uint16_no_val m_kill_warning_delay;
    ...
    OAIV0_0_40_uint32_no_val m_required_switches;
