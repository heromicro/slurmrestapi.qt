...
OAIV0_0_40_controller_ping::OAIV0_0_40_controller_ping() {
    this->initializeModel();
}

OAIV0_0_40_controller_ping::~OAIV0_0_40_controller_ping() {}

void OAIV0_0_40_controller_ping::initializeModel() {
...
void OAIV0_0_40_controller_ping::fromJson(QString jsonString) {
...
QString OAIV0_0_40_controller_ping::asJson() const {
...
QString OAIV0_0_40_controller_ping::getHostname() const {
    return m_hostname;
}
void OAIV0_0_40_controller_ping::setHostname(const QString &hostname) {
    m_hostname = hostname;
    m_hostname_isSet = true;
}

bool OAIV0_0_40_controller_ping::is_hostname_Set() const{
    return m_hostname_isSet;
}

bool OAIV0_0_40_controller_ping::is_hostname_Valid() const{
    return m_hostname_isValid;
}

QString OAIV0_0_40_controller_ping::getPinged() const {
    return m_pinged;
}
void OAIV0_0_40_controller_ping::setPinged(const QString &pinged) {
    m_pinged = pinged;
    m_pinged_isSet = true;
}

bool OAIV0_0_40_controller_ping::is_pinged_Set() const{
    return m_pinged_isSet;
}

bool OAIV0_0_40_controller_ping::is_pinged_Valid() const{
    return m_pinged_isValid;
}

qint64 OAIV0_0_40_controller_ping::getLatency() const {
    return m_latency;
}
void OAIV0_0_40_controller_ping::setLatency(const qint64 &latency) {
    m_latency = latency;
    m_latency_isSet = true;
}

bool OAIV0_0_40_controller_ping::is_latency_Set() const{
    return m_latency_isSet;
}

bool OAIV0_0_40_controller_ping::is_latency_Valid() const{
    return m_latency_isValid;
}

QString OAIV0_0_40_controller_ping::getMode() const {
    return m_mode;
}
void OAIV0_0_40_controller_ping::setMode(const QString &mode) {
    m_mode = mode;
    m_mode_isSet = true;
}

bool OAIV0_0_40_controller_ping::is_mode_Set() const{
    return m_mode_isSet;
}

bool OAIV0_0_40_controller_ping::is_mode_Valid() const{
    return m_mode_isValid;
}

bool OAIV0_0_40_controller_ping::isSet() const {
...
bool OAIV0_0_40_controller_ping::isValid() const {
