...
#ifndef OAIV0_0_39_pings_H
#define OAIV0_0_39_pings_H
...
class OAIV0_0_39_controller_ping;

class OAIV0_0_39_pings : public OAIObject {
public:
    OAIV0_0_39_pings();
    OAIV0_0_39_pings(QString json);
    ~OAIV0_0_39_pings() override;
    ...
    QList<OAIV0_0_39_controller_ping> getPings() const;
    void setPings(const QList<OAIV0_0_39_controller_ping> &pings);
...
private:
    ...
    QList<OAIV0_0_39_controller_ping> m_pings;
    bool m_pings_isSet;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_39_pings)

#endif // OAIV0_0_39_pings_H
