...
/*
 * OAIV0_0_40_openapi_slurmdbd_config_resp.h
 *
 * 
 */

#ifndef OAIV0_0_40_openapi_slurmdbd_config_resp_H
#define OAIV0_0_40_openapi_slurmdbd_config_resp_H
...
class OAIV0_0_40_user;
class OAIV0_0_40_qos;
class OAIV0_0_40_wckey;
class OAIV0_0_40_assoc;
class OAIV0_0_40_instance;
class OAIV0_0_40_openapi_meta;
class OAIV0_0_40_openapi_error;
class OAIV0_0_40_openapi_warning;

class OAIV0_0_40_openapi_slurmdbd_config_resp : public OAIObject {
public:
    OAIV0_0_40_openapi_slurmdbd_config_resp();
    OAIV0_0_40_openapi_slurmdbd_config_resp(QString json);
    ~OAIV0_0_40_openapi_slurmdbd_config_resp() override;
    ...
    QList<OAIV0_0_40_cluster_rec> getClusters() const;
    void setClusters(const QList<OAIV0_0_40_cluster_rec> &clusters);
    ...
    QList<OAIV0_0_40_account> getAccounts() const;
    void setAccounts(const QList<OAIV0_0_40_account> &accounts);
    bool is_accounts_Set() const;
    bool is_accounts_Valid() const;

    QList<OAIV0_0_40_user> getUsers() const;
    void setUsers(const QList<OAIV0_0_40_user> &users);
    ...
    QList<OAIV0_0_40_wckey> getWckeys() const;
    void setWckeys(const QList<OAIV0_0_40_wckey> &wckeys);
    bool is_wckeys_Set() const;
    bool is_wckeys_Valid() const;

    QList<OAIV0_0_40_assoc> getAssociations() const;
    void setAssociations(const QList<OAIV0_0_40_assoc> &associations);
    bool is_associations_Set() const;
    bool is_associations_Valid() const;

    QList<OAIV0_0_40_instance> getInstances() const;
    void setInstances(const QList<OAIV0_0_40_instance> &instances);
...
private:
    ...
    QList<OAIV0_0_40_cluster_rec> m_clusters;
    ...
    QList<OAIV0_0_40_account> m_accounts;
    bool m_accounts_isSet;
    bool m_accounts_isValid;

    QList<OAIV0_0_40_user> m_users;
    bool m_users_isSet;
    ...
    QList<OAIV0_0_40_wckey> m_wckeys;
    bool m_wckeys_isSet;
    bool m_wckeys_isValid;

    QList<OAIV0_0_40_assoc> m_associations;
    bool m_associations_isSet;
    bool m_associations_isValid;

    QList<OAIV0_0_40_instance> m_instances;
