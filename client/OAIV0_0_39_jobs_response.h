...
#ifndef OAIV0_0_39_jobs_response_H
#define OAIV0_0_39_jobs_response_H
...
class OAIV0_0_39_job_info;

class OAIV0_0_39_jobs_response : public OAIObject {
public:
    OAIV0_0_39_jobs_response();
    OAIV0_0_39_jobs_response(QString json);
    ~OAIV0_0_39_jobs_response() override;
    ...
    QList<OAIV0_0_39_job_info> getJobs() const;
    void setJobs(const QList<OAIV0_0_39_job_info> &jobs);
...
private:
    ...
    QList<OAIV0_0_39_job_info> m_jobs;
    bool m_jobs_isSet;
    bool m_jobs_isValid;
};
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_39_jobs_response)

#endif // OAIV0_0_39_jobs_response_H
