...
#include "OAIV0_0_40_stats_rec.h"
...
OAIV0_0_40_stats_rec::OAIV0_0_40_stats_rec() {
    this->initializeModel();
}

OAIV0_0_40_stats_rec::~OAIV0_0_40_stats_rec() {}

void OAIV0_0_40_stats_rec::initializeModel() {
...
void OAIV0_0_40_stats_rec::fromJson(QString jsonString) {
...
QString OAIV0_0_40_stats_rec::asJson() const {
...
qint64 OAIV0_0_40_stats_rec::getTimeStart() const {
    return m_time_start;
}
void OAIV0_0_40_stats_rec::setTimeStart(const qint64 &time_start) {
    m_time_start = time_start;
    m_time_start_isSet = true;
}

bool OAIV0_0_40_stats_rec::is_time_start_Set() const{
    return m_time_start_isSet;
}

bool OAIV0_0_40_stats_rec::is_time_start_Valid() const{
    return m_time_start_isValid;
}

QList<OAIV0_0_40_rollup_stats_inner> OAIV0_0_40_stats_rec::getRollups() const {
    return m_rollups;
}
void OAIV0_0_40_stats_rec::setRollups(const QList<OAIV0_0_40_rollup_stats_inner> &rollups) {
    m_rollups = rollups;
    m_rollups_isSet = true;
}

bool OAIV0_0_40_stats_rec::is_rollups_Set() const{
    return m_rollups_isSet;
}

bool OAIV0_0_40_stats_rec::is_rollups_Valid() const{
    return m_rollups_isValid;
}

QList<OAIV0_0_40_stats_rpc> OAIV0_0_40_stats_rec::getRpcs() const {
    return m_rpcs;
}
void OAIV0_0_40_stats_rec::setRpcs(const QList<OAIV0_0_40_stats_rpc> &rpcs) {
    m_rpcs = rpcs;
    m_rpcs_isSet = true;
}

bool OAIV0_0_40_stats_rec::is_rpcs_Set() const{
    return m_rpcs_isSet;
}

bool OAIV0_0_40_stats_rec::is_rpcs_Valid() const{
    return m_rpcs_isValid;
}

QList<OAIV0_0_40_stats_user> OAIV0_0_40_stats_rec::getUsers() const {
    return m_users;
}
void OAIV0_0_40_stats_rec::setUsers(const QList<OAIV0_0_40_stats_user> &users) {
    m_users = users;
    m_users_isSet = true;
}

bool OAIV0_0_40_stats_rec::is_users_Set() const{
    return m_users_isSet;
}

bool OAIV0_0_40_stats_rec::is_users_Valid() const{
    return m_users_isValid;
}

bool OAIV0_0_40_stats_rec::isSet() const {
...
bool OAIV0_0_40_stats_rec::isValid() const {
