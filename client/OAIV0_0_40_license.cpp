...
OAIV0_0_40_license::OAIV0_0_40_license(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIV0_0_40_license::OAIV0_0_40_license() {
    this->initializeModel();
}

OAIV0_0_40_license::~OAIV0_0_40_license() {}

void OAIV0_0_40_license::initializeModel() {
...
void OAIV0_0_40_license::fromJson(QString jsonString) {
...
void OAIV0_0_40_license::fromJsonObject(QJsonObject json) {
...
QString OAIV0_0_40_license::asJson() const {
...
QJsonObject OAIV0_0_40_license::asJsonObject() const {
    QJsonObject obj;
...
QString OAIV0_0_40_license::getLicenseName() const {
    return m_license_name;
}
void OAIV0_0_40_license::setLicenseName(const QString &license_name) {
    m_license_name = license_name;
    m_license_name_isSet = true;
}

bool OAIV0_0_40_license::is_license_name_Set() const{
    return m_license_name_isSet;
}

bool OAIV0_0_40_license::is_license_name_Valid() const{
    return m_license_name_isValid;
}

qint32 OAIV0_0_40_license::getTotal() const {
    return m_total;
}
void OAIV0_0_40_license::setTotal(const qint32 &total) {
    m_total = total;
    m_total_isSet = true;
}

bool OAIV0_0_40_license::is_total_Set() const{
    return m_total_isSet;
}

bool OAIV0_0_40_license::is_total_Valid() const{
    return m_total_isValid;
}

qint32 OAIV0_0_40_license::getUsed() const {
    return m_used;
}
void OAIV0_0_40_license::setUsed(const qint32 &used) {
    m_used = used;
    m_used_isSet = true;
}

bool OAIV0_0_40_license::is_used_Set() const{
    return m_used_isSet;
}

bool OAIV0_0_40_license::is_used_Valid() const{
    return m_used_isValid;
}

qint32 OAIV0_0_40_license::getFree() const {
    return m_free;
}
void OAIV0_0_40_license::setFree(const qint32 &free) {
    m_free = free;
    m_free_isSet = true;
}

bool OAIV0_0_40_license::is_free_Set() const{
    return m_free_isSet;
}

bool OAIV0_0_40_license::is_free_Valid() const{
    return m_free_isValid;
}

bool OAIV0_0_40_license::isRemote() const {
    return m_remote;
}
void OAIV0_0_40_license::setRemote(const bool &remote) {
    m_remote = remote;
    m_remote_isSet = true;
}

bool OAIV0_0_40_license::is_remote_Set() const{
    return m_remote_isSet;
}

bool OAIV0_0_40_license::is_remote_Valid() const{
    return m_remote_isValid;
}

qint32 OAIV0_0_40_license::getReserved() const {
    return m_reserved;
}
void OAIV0_0_40_license::setReserved(const qint32 &reserved) {
    m_reserved = reserved;
    m_reserved_isSet = true;
}

bool OAIV0_0_40_license::is_reserved_Set() const{
    return m_reserved_isSet;
}

bool OAIV0_0_40_license::is_reserved_Valid() const{
    return m_reserved_isValid;
}

qint32 OAIV0_0_40_license::getLastConsumed() const {
    return m_last_consumed;
}
void OAIV0_0_40_license::setLastConsumed(const qint32 &last_consumed) {
    m_last_consumed = last_consumed;
    m_last_consumed_isSet = true;
}

bool OAIV0_0_40_license::is_last_consumed_Set() const{
    return m_last_consumed_isSet;
}

bool OAIV0_0_40_license::is_last_consumed_Valid() const{
    return m_last_consumed_isValid;
}

qint32 OAIV0_0_40_license::getLastDeficit() const {
    return m_last_deficit;
}
void OAIV0_0_40_license::setLastDeficit(const qint32 &last_deficit) {
    m_last_deficit = last_deficit;
    m_last_deficit_isSet = true;
}

bool OAIV0_0_40_license::is_last_deficit_Set() const{
    return m_last_deficit_isSet;
}

bool OAIV0_0_40_license::is_last_deficit_Valid() const{
    return m_last_deficit_isValid;
}

qint64 OAIV0_0_40_license::getLastUpdate() const {
    return m_last_update;
}
void OAIV0_0_40_license::setLastUpdate(const qint64 &last_update) {
    m_last_update = last_update;
    m_last_update_isSet = true;
}

bool OAIV0_0_40_license::is_last_update_Set() const{
    return m_last_update_isSet;
}

bool OAIV0_0_40_license::is_last_update_Valid() const{
    return m_last_update_isValid;
}

bool OAIV0_0_40_license::isSet() const {
...
bool OAIV0_0_40_license::isValid() const {
