...
void OAIV0_0_41_openapi_diag_resp_statistics::fromJsonObject(QJsonObject json) {
    ...
    m_schedule_cycle_sum_isValid = ::OpenAPI::fromJsonValue(m_schedule_cycle_sum, json[QString("schedule_cycle_sum")]);
    ...
    m_schedule_cycle_depth_isValid = ::OpenAPI::fromJsonValue(m_schedule_cycle_depth, json[QString("schedule_cycle_depth")]);
    ...
    m_bf_cycle_max_isValid = ::OpenAPI::fromJsonValue(m_bf_cycle_max, json[QString("bf_cycle_max")]);
    ...
    m_bf_table_size_sum_isValid = ::OpenAPI::fromJsonValue(m_bf_table_size_sum, json[QString("bf_table_size_sum")]);
    ...
    m_pending_rpcs_isValid = ::OpenAPI::fromJsonValue(m_pending_rpcs, json[QString("pending_rpcs")]);
    m_pending_rpcs_isSet = !json[QString("pending_rpcs")].isNull() && m_pending_rpcs_isValid;

    m_pending_rpcs_by_hostlist_isValid = ::OpenAPI::fromJsonValue(m_pending_rpcs_by_hostlist, json[QString("pending_rpcs_by_hostlist")]);
...
QJsonObject OAIV0_0_41_openapi_diag_resp_statistics::asJsonObject() const {
    ...
    if (m_schedule_cycle_sum_isSet) {
        obj.insert(QString("schedule_cycle_sum"), ::OpenAPI::toJsonValue(m_schedule_cycle_sum));
    }
    ...
    if (m_schedule_cycle_depth_isSet) {
        obj.insert(QString("schedule_cycle_depth"), ::OpenAPI::toJsonValue(m_schedule_cycle_depth));
    }
    ...
    if (m_bf_cycle_max_isSet) {
        obj.insert(QString("bf_cycle_max"), ::OpenAPI::toJsonValue(m_bf_cycle_max));
    }
    if (m_bf_exit.isSet()) {
    ...
    if (m_bf_table_size_sum_isSet) {
        obj.insert(QString("bf_table_size_sum"), ::OpenAPI::toJsonValue(m_bf_table_size_sum));
    }
    ...
    if (m_pending_rpcs.size() > 0) {
        obj.insert(QString("pending_rpcs"), ::OpenAPI::toJsonValue(m_pending_rpcs));
    }
    if (m_pending_rpcs_by_hostlist.size() > 0) {
        obj.insert(QString("pending_rpcs_by_hostlist"), ::OpenAPI::toJsonValue(m_pending_rpcs_by_hostlist));
    }
    return obj;
}
