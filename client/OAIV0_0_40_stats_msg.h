...
/*
 * OAIV0_0_40_stats_msg.h
 *
 * 
 */

#ifndef OAIV0_0_40_stats_msg_H
#define OAIV0_0_40_stats_msg_H
...
class OAIV0_0_40_stats_msg : public OAIObject {
public:
    OAIV0_0_40_stats_msg();
    OAIV0_0_40_stats_msg(QString json);
    ~OAIV0_0_40_stats_msg() override;
    ...
    OAIV0_0_40_uint64_no_val getReqTime() const;
    void setReqTime(const OAIV0_0_40_uint64_no_val &req_time);
    bool is_req_time_Set() const;
    bool is_req_time_Valid() const;

    OAIV0_0_40_uint64_no_val getReqTimeStart() const;
    void setReqTimeStart(const OAIV0_0_40_uint64_no_val &req_time_start);
    ...
    OAIV0_0_40_schedule_exit_fields getScheduleExit() const;
    void setScheduleExit(const OAIV0_0_40_schedule_exit_fields &schedule_exit);
    ...
    OAIV0_0_40_uint64_no_val getJobStatesTs() const;
    void setJobStatesTs(const OAIV0_0_40_uint64_no_val &job_states_ts);
    ...
    OAIV0_0_40_uint64_no_val getBfWhenLastCycle() const;
    void setBfWhenLastCycle(const OAIV0_0_40_uint64_no_val &bf_when_last_cycle);
    ...
    OAIV0_0_40_bf_exit_fields getBfExit() const;
    void setBfExit(const OAIV0_0_40_bf_exit_fields &bf_exit);
...
private:
    ...
    OAIV0_0_40_uint64_no_val m_req_time;
    bool m_req_time_isSet;
    bool m_req_time_isValid;

    OAIV0_0_40_uint64_no_val m_req_time_start;
    ...
    OAIV0_0_40_schedule_exit_fields m_schedule_exit;
    ...
    OAIV0_0_40_uint64_no_val m_job_states_ts;
    ...
    OAIV0_0_40_uint64_no_val m_bf_when_last_cycle;
    ...
    OAIV0_0_40_bf_exit_fields m_bf_exit;
