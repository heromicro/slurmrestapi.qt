...
/*
 * OAIV0_0_40_accounting.h
 *
 * 
 */

#ifndef OAIV0_0_40_accounting_H
#define OAIV0_0_40_accounting_H
...
class OAIV0_0_40_accounting : public OAIObject {
public:
    OAIV0_0_40_accounting();
    OAIV0_0_40_accounting(QString json);
    ~OAIV0_0_40_accounting() override;
    ...
    OAIV0_0_40_tres getTres() const;
    void setTres(const OAIV0_0_40_tres &tres);
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_40_accounting)

#endif // OAIV0_0_40_accounting_H
