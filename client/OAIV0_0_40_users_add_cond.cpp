...
OAIV0_0_40_users_add_cond::OAIV0_0_40_users_add_cond(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIV0_0_40_users_add_cond::OAIV0_0_40_users_add_cond() {
    this->initializeModel();
}

OAIV0_0_40_users_add_cond::~OAIV0_0_40_users_add_cond() {}

void OAIV0_0_40_users_add_cond::initializeModel() {
...
void OAIV0_0_40_users_add_cond::fromJson(QString jsonString) {
...
void OAIV0_0_40_users_add_cond::fromJsonObject(QJsonObject json) {
...
QString OAIV0_0_40_users_add_cond::asJson() const {
...
QJsonObject OAIV0_0_40_users_add_cond::asJsonObject() const {
    QJsonObject obj;
...
QList<QString> OAIV0_0_40_users_add_cond::getAccounts() const {
    return m_accounts;
}
void OAIV0_0_40_users_add_cond::setAccounts(const QList<QString> &accounts) {
    m_accounts = accounts;
    m_accounts_isSet = true;
}

bool OAIV0_0_40_users_add_cond::is_accounts_Set() const{
    return m_accounts_isSet;
}

bool OAIV0_0_40_users_add_cond::is_accounts_Valid() const{
    return m_accounts_isValid;
}

OAIV0_0_40_assoc_rec_set OAIV0_0_40_users_add_cond::getAssociation() const {
    return m_association;
}
void OAIV0_0_40_users_add_cond::setAssociation(const OAIV0_0_40_assoc_rec_set &association) {
    m_association = association;
    m_association_isSet = true;
}

bool OAIV0_0_40_users_add_cond::is_association_Set() const{
    return m_association_isSet;
}

bool OAIV0_0_40_users_add_cond::is_association_Valid() const{
    return m_association_isValid;
}

QList<QString> OAIV0_0_40_users_add_cond::getClusters() const {
    return m_clusters;
}
void OAIV0_0_40_users_add_cond::setClusters(const QList<QString> &clusters) {
    m_clusters = clusters;
    m_clusters_isSet = true;
}

bool OAIV0_0_40_users_add_cond::is_clusters_Set() const{
    return m_clusters_isSet;
}

bool OAIV0_0_40_users_add_cond::is_clusters_Valid() const{
    return m_clusters_isValid;
}

QList<QString> OAIV0_0_40_users_add_cond::getPartitions() const {
    return m_partitions;
}
void OAIV0_0_40_users_add_cond::setPartitions(const QList<QString> &partitions) {
    m_partitions = partitions;
    m_partitions_isSet = true;
}

bool OAIV0_0_40_users_add_cond::is_partitions_Set() const{
    return m_partitions_isSet;
}

bool OAIV0_0_40_users_add_cond::is_partitions_Valid() const{
    return m_partitions_isValid;
}

QList<QString> OAIV0_0_40_users_add_cond::getUsers() const {
    return m_users;
}
void OAIV0_0_40_users_add_cond::setUsers(const QList<QString> &users) {
    m_users = users;
    m_users_isSet = true;
}

bool OAIV0_0_40_users_add_cond::is_users_Set() const{
    return m_users_isSet;
}

bool OAIV0_0_40_users_add_cond::is_users_Valid() const{
    return m_users_isValid;
}

QList<QString> OAIV0_0_40_users_add_cond::getWckeys() const {
    return m_wckeys;
}
void OAIV0_0_40_users_add_cond::setWckeys(const QList<QString> &wckeys) {
    m_wckeys = wckeys;
    m_wckeys_isSet = true;
}

bool OAIV0_0_40_users_add_cond::is_wckeys_Set() const{
    return m_wckeys_isSet;
}

bool OAIV0_0_40_users_add_cond::is_wckeys_Valid() const{
    return m_wckeys_isValid;
}

bool OAIV0_0_40_users_add_cond::isSet() const {
...
bool OAIV0_0_40_users_add_cond::isValid() const {
