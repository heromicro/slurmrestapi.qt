...
/*
 * OAIV0_0_41_openapi_reservation_resp.h
 *
 * 
 */

#ifndef OAIV0_0_41_openapi_reservation_resp_H
#define OAIV0_0_41_openapi_reservation_resp_H
...
class OAIV0_0_41_openapi_reservation_resp_reservations_inner;
class OAIV0_0_41_openapi_reservation_resp_last_update;
...
class OAIV0_0_41_openapi_reservation_resp : public OAIObject {
public:
    OAIV0_0_41_openapi_reservation_resp();
    OAIV0_0_41_openapi_reservation_resp(QString json);
    ~OAIV0_0_41_openapi_reservation_resp() override;
    ...
    QList<OAIV0_0_41_openapi_reservation_resp_reservations_inner> getReservations() const;
    void setReservations(const QList<OAIV0_0_41_openapi_reservation_resp_reservations_inner> &reservations);
    bool is_reservations_Set() const;
    bool is_reservations_Valid() const;

    OAIV0_0_41_openapi_reservation_resp_last_update getLastUpdate() const;
    void setLastUpdate(const OAIV0_0_41_openapi_reservation_resp_last_update &last_update);
...
private:
    ...
    QList<OAIV0_0_41_openapi_reservation_resp_reservations_inner> m_reservations;
    bool m_reservations_isSet;
    bool m_reservations_isValid;

    OAIV0_0_41_openapi_reservation_resp_last_update m_last_update;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_41_openapi_reservation_resp)

#endif // OAIV0_0_41_openapi_reservation_resp_H
