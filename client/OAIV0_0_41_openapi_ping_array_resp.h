...
/*
 * OAIV0_0_41_openapi_ping_array_resp.h
 *
 * 
 */

#ifndef OAIV0_0_41_openapi_ping_array_resp_H
#define OAIV0_0_41_openapi_ping_array_resp_H
...
class OAIV0_0_41_openapi_ping_array_resp_pings_inner;
...
class OAIV0_0_41_openapi_ping_array_resp : public OAIObject {
public:
    OAIV0_0_41_openapi_ping_array_resp();
    OAIV0_0_41_openapi_ping_array_resp(QString json);
    ~OAIV0_0_41_openapi_ping_array_resp() override;
    ...
    QList<OAIV0_0_41_openapi_ping_array_resp_pings_inner> getPings() const;
    void setPings(const QList<OAIV0_0_41_openapi_ping_array_resp_pings_inner> &pings);
...
private:
    ...
    QList<OAIV0_0_41_openapi_ping_array_resp_pings_inner> m_pings;
    bool m_pings_isSet;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_41_openapi_ping_array_resp)

#endif // OAIV0_0_41_openapi_ping_array_resp_H
