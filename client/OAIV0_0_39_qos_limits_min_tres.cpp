...
OAIV0_0_39_qos_limits_min_tres_per OAIV0_0_39_qos_limits_min_tres::getPer() const {
    return m_per;
}
void OAIV0_0_39_qos_limits_min_tres::setPer(const OAIV0_0_39_qos_limits_min_tres_per &per) {
    m_per = per;
    m_per_isSet = true;
}
