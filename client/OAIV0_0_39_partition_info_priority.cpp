...
qint32 OAIV0_0_39_partition_info_priority::getJobFactor() const {
    return m_job_factor;
}
void OAIV0_0_39_partition_info_priority::setJobFactor(const qint32 &job_factor) {
    m_job_factor = job_factor;
    m_job_factor_isSet = true;
}

bool OAIV0_0_39_partition_info_priority::is_job_factor_Set() const{
    return m_job_factor_isSet;
}

bool OAIV0_0_39_partition_info_priority::is_job_factor_Valid() const{
