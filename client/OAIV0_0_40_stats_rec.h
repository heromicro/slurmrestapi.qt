...
/*
 * OAIV0_0_40_stats_rec.h
 *
 * 
 */

#ifndef OAIV0_0_40_stats_rec_H
#define OAIV0_0_40_stats_rec_H
...
class OAIV0_0_40_stats_rpc;
class OAIV0_0_40_stats_user;

class OAIV0_0_40_stats_rec : public OAIObject {
public:
    OAIV0_0_40_stats_rec();
    OAIV0_0_40_stats_rec(QString json);
    ~OAIV0_0_40_stats_rec() override;
    ...
    QList<OAIV0_0_40_stats_rpc> getRpcs() const;
    void setRpcs(const QList<OAIV0_0_40_stats_rpc> &rpcs);
    bool is_rpcs_Set() const;
    bool is_rpcs_Valid() const;

    QList<OAIV0_0_40_stats_user> getUsers() const;
    void setUsers(const QList<OAIV0_0_40_stats_user> &users);
...
private:
    ...
    QList<OAIV0_0_40_stats_rpc> m_rpcs;
    bool m_rpcs_isSet;
    bool m_rpcs_isValid;

    QList<OAIV0_0_40_stats_user> m_users;
    bool m_users_isSet;
...
Q_DECLARE_METATYPE(hm:slurm:client::OAIV0_0_40_stats_rec)

#endif // OAIV0_0_40_stats_rec_H
